package spark.layouts.supportClasses
{
   ...
   public final class LinearLayoutVector
   {
      ...
      public function setMajorSize(param1:uint, param2:Number) : void
      {
         ...
         var _loc3_:uint = uint(param1 >> BLOCK_SHIFT);
         var _loc4_:Block = this.blockTable[_loc3_];
         if(!_loc4_)
         {
            _loc4_ = this.blockTable[_loc3_] = new Block();
         }
         var _loc5_:uint = uint(param1 & BLOCK_MASK);
         var _loc6_:Vector.<Number> = _loc4_.sizes;
      ...
      {
         var _loc6_:Boolean = param2 < param4;
         var _loc7_:int = _loc6_ ? param4 : int(param4 + param5 - 1);
         var _loc8_:int = _loc6_ ? param2 : int(param2 + param5 - 1);
      ...
      private function copyInterval(param1:int, param2:int, param3:int) : void
      {
         ...
         while(param3 > 0)
         {
            ...
            if(Boolean(_loc10_) && Boolean(!_loc7_) && this.isIntervalClear(_loc10_,_loc13_,_loc11_))
            {
               _loc7_ = new Block();
            ...
            if(_loc7_)
            {
               ...
               {
                  _loc14_ = _loc4_ ? _loc12_ + _loc11_ == BLOCK_SIZE : _loc12_ == 0;
                  if((_loc14_) || param3 == _loc11_)
                  {
      ...
      public function start(param1:uint) : Number
      {
         ...
         var _loc6_:uint = uint(param1 & ~BLOCK_MASK);
