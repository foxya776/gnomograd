package spark.layouts
{
   ...
   public class HorizontalLayout extends LayoutBase
   {
      ...
      {
         var _loc3_:Number = LayoutElementHelper.pinBetween(Math.round(param1.percentHeight * 0.01 * param2),param1.getMinBoundsHeight(),param1.getMaxBoundsHeight());
      ...
      private static function findLayoutElementIndex(param1:GroupBase, param2:int, param3:int) : int
      {
         ...
         while(param2 >= 0 && param2 < _loc4_)
         {
            ...
            if((Boolean(_loc5_)) && _loc5_.includeInLayout)
            {
               return param2;
            }
            param2 += param3;
      ...
      private function getElementWidth(param1:ILayoutElement, param2:Number, param3:SizesAndLimit) : void
      {
         ...
         var _loc5_:Boolean = !isNaN(param1.percentWidth);
         var _loc6_:Number = _loc5_ ? Math.ceil(param1.getMinBoundsWidth()) : _loc4_;
      ...
      private function getElementHeight(param1:ILayoutElement, param2:Boolean, param3:SizesAndLimit) : void
      {
         ...
         var _loc6_:Number = _loc5_ ? Math.ceil(param1.getMinBoundsHeight()) : _loc4_;
         param3.preferredSize = _loc4_;
         param3.minSize = _loc6_;
      }
      ...
      private function calculateBaselineTopBottom(param1:Boolean) : Array
      {
         ...
         var _loc4_:Number = 0;
         var _loc5_:Number = 0;
         var _loc7_:Array = LayoutElementHelper.parseConstraintExp(this.mx_internal::alignmentBaseline);
         ...
         while(_loc9_ < _loc8_)
         {
            ...
            if(!(!_loc10_ || !_loc10_.includeInLayout))
            {
               ...
               if(param1)
               {
                  ...
                  _loc16_ = _loc15_ = _loc14_ - _loc13_;
      ...
      private function measureReal(param1:GroupBase) : void
      {
         ...
         var _loc3_:Boolean = this.verticalAlign == VerticalAlign.BASELINE;
         var _loc4_:Boolean = this.verticalAlign == VerticalAlign.JUSTIFY;
         var _loc5_:int;
         var _loc6_:* = _loc5_ = param1.numElements;
         ...
         if(this.variableColumnWidth)
         {
            ...
            if(_loc8_)
            {
               ...
               for each(_loc10_ in _loc9_)
               {
                  ...
                  if(_loc11_)
                  {
                     _loc7_ -= this.llv.getMajorSize(_loc10_);
         ...
         switch(param2)
         {
            ...
            case NavigationUnit.PAGE_LEFT:
               ...
               while(0 <= _loc5_)
               {
                  ...
                  if((Boolean(_loc6_)) && _loc6_.left < _loc7_)
                  {
                     _loc5_ = int(Math.min(param1 - 1,_loc5_ + 1));
                     break;
                  }
                  _loc5_--;
               }
            ...
            case NavigationUnit.PAGE_RIGHT:
               ...
               {
                  _loc6_ = this.getElementBounds(_loc5_);
                  if((Boolean(_loc6_)) && _loc6_.right > _loc7_)
                  {
                     _loc5_ = int(Math.max(param1 + 1,_loc5_ - 1));
                     break;
                  }
                  _loc5_++;
               }
      ...
      private function updateDisplayListVirtual() : void
      {
         ...
         var _loc10_:Boolean = this.verticalAlign == VerticalAlign.JUSTIFY;
         var _loc11_:Number = NaN;
      ...
      private function updateDisplayListReal() : void
      {
         ...
         var _loc9_:Number = 0;
         var _loc10_:Boolean = this.verticalAlign == VerticalAlign.BASELINE;
         if(_loc10_)
         {
            _loc23_ = this.calculateBaselineTopBottom(false);
            _loc9_ = Number(_loc23_[0]);
         }
         var _loc11_:uint = 0;
      ...
      private function distributeWidth(param1:Number, param2:Number, param3:Number) : Number
      {
         ...
         var _loc11_:int;
         var _loc12_:* = _loc11_ = target.numElements;
         var _loc13_:int = 0;
         ...
         while(_loc9_ <= _loc8_)
         {
            ...
            if(_loc10_)
            {
               if(_loc10_.left <= param1 && param1 <= _loc10_.right)
               {
                  ...
                  return param1 < _loc12_ ? _loc9_ : int(_loc9_ + 1);
               }
               _loc11_ = Math.min(Math.abs(param1 - _loc10_.left),Math.abs(param1 - _loc10_.right));
               if(_loc11_ < _loc5_)
               {
                  _loc5_ = _loc11_;
                  _loc6_ = param1 < _loc10_.left ? _loc9_ : int(_loc9_ + 1);
               }
            }
            _loc9_++;
         }
