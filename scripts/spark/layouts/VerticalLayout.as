package spark.layouts
{
   ...
   public class VerticalLayout extends LayoutBase
   {
      ...
      {
         var _loc3_:Number = LayoutElementHelper.pinBetween(Math.round(param1.percentWidth * 0.01 * param2),param1.getMinBoundsWidth(),param1.getMaxBoundsWidth());
      ...
      private function setRowCount(param1:int) : void
      {
      ...
      private function getElementHeight(param1:ILayoutElement, param2:Number, param3:SizesAndLimit) : void
      {
         ...
         var _loc5_:Boolean = !isNaN(param1.percentHeight);
         var _loc6_:Number = _loc5_ ? Math.ceil(param1.getMinBoundsHeight()) : _loc4_;
         param3.preferredSize = _loc4_;
         param3.minSize = _loc6_;
      }
      
      private function getRowsToMeasure(param1:int) : int
      {
         var _loc2_:int = 0;
      ...
      private function measureReal(param1:GroupBase) : void
      {
         ...
         var _loc3_:Boolean = this.horizontalAlign == HorizontalAlign.JUSTIFY;
         var _loc4_:int;
         var _loc5_:* = _loc4_ = param1.numElements;
      ...
      {
         if(Boolean(this.llv) && Boolean(param1 >= 0) && useVirtualLayout)
         {
         ...
         switch(param2)
         {
            ...
            case NavigationUnit.PAGE_UP:
               ...
               while(0 <= _loc5_)
               {
                  ...
                  if((Boolean(_loc6_)) && _loc6_.top < _loc7_)
                  {
            ...
            case NavigationUnit.PAGE_DOWN:
               ...
               {
                  _loc6_ = this.getElementBounds(_loc5_);
                  if((Boolean(_loc6_)) && _loc6_.bottom > _loc7_)
                  {
      ...
      private function updateDisplayListVirtual() : void
      {
         ...
         var _loc10_:Boolean = this.horizontalAlign == HorizontalAlign.JUSTIFY;
         var _loc11_:Number = _loc10_ ? _loc3_ : NaN;
         var _loc12_:Number = NaN;
      ...
      private function distributeHeight(param1:Number, param2:Number, param3:Number) : Number
      {
         ...
         var _loc10_:int;
         var _loc11_:* = _loc10_ = target.numElements;
         var _loc12_:int = 0;
         ...
         while(_loc9_ <= _loc8_)
         {
            ...
            if(_loc10_)
            {
               if(_loc10_.top <= param2 && param2 <= _loc10_.bottom)
               {
                  ...
                  return param2 < _loc12_ ? _loc9_ : int(_loc9_ + 1);
               }
               _loc11_ = Math.min(Math.abs(param2 - _loc10_.top),Math.abs(param2 - _loc10_.bottom));
               if(_loc11_ < _loc5_)
               {
                  _loc5_ = _loc11_;
                  _loc6_ = param2 < _loc10_.top ? _loc9_ : int(_loc9_ + 1);
               }
            }
            _loc9_++;
         }
