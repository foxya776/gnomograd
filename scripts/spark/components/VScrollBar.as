   ...
   public class VScrollBar extends ScrollBarBase
   {
      ...
      override protected function updateSkinDisplayList() : void
      {
         ...
         if(pendingValue < _loc2_)
         {
            if(!_loc5_)
            {
               _loc9_ = Math.max(Math.min(thumb.minHeight,_loc9_),_loc9_ + pendingValue);
            }
            _loc7_ = _loc2_;
         }
      ...
      override public function changeValueByPage(param1:Boolean = true) : void
      {
         ...
         {
            _loc2_ = pageSize;
            pageSize = Math.abs(viewport.getVerticalScrollPositionDelta(param1 ? NavigationUnit.PAGE_DOWN : NavigationUnit.PAGE_UP));
         }
      ...
      override protected function animatePaging(param1:Number, param2:Number) : void
      {
         ...
         if(viewport)
         {
            _loc3_ = Math.abs(viewport.getVerticalScrollPositionDelta(param1 > value ? NavigationUnit.PAGE_DOWN : NavigationUnit.PAGE_UP));
      ...
      override public function changeValueByStep(param1:Boolean = true) : void
      {
         ...
         {
            _loc2_ = stepSize;
            stepSize = Math.abs(viewport.getVerticalScrollPositionDelta(param1 ? NavigationUnit.DOWN : NavigationUnit.UP));
         }
