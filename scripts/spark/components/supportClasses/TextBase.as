package spark.components.supportClasses
{
   ...
   public class TextBase extends UIComponent implements IDisplayText
   {
      ...
      {
         if(TextBase.mx_internal::createAccessibilityImplementation != null)
         {
      ...
      mx_internal function addTextLines() : void
      {
         ...
         var _loc1_:int = int(this.mx_internal::textLines.length);
         if(_loc1_ == 0)
         {
            return;
         }
      ...
      mx_internal function isTextOverset(param1:Number, param2:Number) : Boolean
      {
         ...
         var _loc4_:Rectangle = this.mx_internal::bounds;
         return _loc4_.top < _loc3_.top || _loc4_.left < _loc3_.left || !isNaN(_loc3_.bottom) && _loc4_.bottom > _loc3_.bottom || !isNaN(_loc3_.right) && _loc4_.right > _loc3_.right;
      }
