package spark.components.supportClasses
{
   ...
   public class ButtonBase extends SkinnableComponent implements IFocusManagerComponent
   {
      ...
      {
         if(ButtonBase.mx_internal::createAccessibilityImplementation != null)
         {
      ...
      private function checkAutoRepeatTimerConditions(param1:Boolean) : void
      {
         ...
         var _loc3_:Boolean = this.autoRepeatTimer != null;
         if(_loc2_ == _loc3_)
         {
            return;
         }
      ...
      {
         var _loc1_:Number = this.mx_internal::disableMinimumDownStateTime ? 0 : Number(getStyle("touchDelay"));
         if(_loc1_ > 0)
         {
