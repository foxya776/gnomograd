package spark.components.supportClasses
{
   ...
   public class ScrollerLayout extends LayoutBase
   {
      ...
      override public function measure() : void
      {
         ...
         var _loc12_:IViewport = _loc1_.viewport;
         if(_loc12_)
         {
            if(_loc3_)
            {
         ...
         var _loc15_:IUIComponent = _loc12_ as IUIComponent;
         ...
         var _loc18_:GroupBase = target;
         _loc18_.measuredWidth = Math.ceil(_loc4_);
      ...
      override public function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         if(_loc4_)
         {
            _loc23_ = this.getLayoutContentSize(_loc4_);
            _loc8_ = _loc23_.x;
            _loc9_ = _loc23_.y;
         }
         var _loc10_:IUIComponent = _loc4_ as IUIComponent;
         ...
         if(this.invalidationCount < 2 && (this.vsbVisible != _loc16_ && _loc19_ || this.hsbVisible != _loc15_ && _loc17_))
         {
            ...
            _loc28_ = _loc4_ as GroupBase;
            if((Boolean(_loc28_)) && Boolean(_loc28_.layout) && _loc28_.layout.useVirtualLayout)
            {
