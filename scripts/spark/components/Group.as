   ...
   public class Group extends GroupBase implements IVisualElementContainer, IGraphicElementContainer, ISharedDisplayObject
   {
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         if(this.scaleGridChanged)
         {
            ...
            if(this.isValidScaleGrid())
            {
               _loc4_ = mx_internal::_overlay ? mx_internal::_overlay.numDisplayObjects : 0;
      ...
      override public function regenerateStyleCache(param1:Boolean) : void
      {
         ...
         if(mx_internal::advanceStyleClientChildren != null)
         {
            for(_loc5_ in mx_internal::advanceStyleClientChildren)
            {
               ...
               if((Boolean(_loc6_)) && _loc6_.inheritingStyles != StyleProtoChain.STYLE_UNINITIALIZED)
               {
      ...
      private function assignDisplayObjectTo(param1:IVisualElement, param2:IVisualElement, param3:int) : int
      {
         ...
         else if(param1 is IGraphicElement)
         {
            ...
            if(Boolean(_loc5_ && _loc5_.canShareWithNext(_loc4_)) && Boolean(_loc4_.canShareWithPrevious(_loc5_)) && _loc4_.setSharedDisplayObject(_loc5_.displayObject))
            {
      ...
      private function invalidateAfterAssignment(param1:IGraphicElement, param2:String, param3:DisplayObject) : void
      {
         ...
         if(Boolean(param3 && param3.parent == this) && Boolean(param3 != _loc4_) && param2 != DisplayObjectSharingMode.USES_SHARED_OBJECT)
         {
      ...
      {
         var _loc3_:int = mx_internal::_overlay ? mx_internal::_overlay.numDisplayObjects : 0;
         if(param1.parent == this)
         {
            super.setChildIndex(param1,param2 != -1 ? param2 : int(super.numChildren - 1 - _loc3_));
         }
         else
         {
            super.addChildAt(param1,param2 != -1 ? param2 : int(super.numChildren - _loc3_));
         }
      }
