package spark.components
{
   ...
   public class Application extends SkinnableContainer
   {
      ...
      public function set colorCorrection(param1:String) : void
      {
         ...
         if(Boolean(_loc2_) && Boolean(_loc2_.stage) && _loc2_.isTopLevelRoot())
         {
      ...
      override public function initialize() : void
      {
         ...
         if(Boolean(_loc1_) && Boolean(_loc1_.stage) && _loc1_.isTopLevelRoot())
         {
      ...
      private function stage_orientationChangingHandler(param1:Event) : void
      {
         ...
         if(isNaN(explicitWidth) && isNaN(explicitHeight))
         {
            ...
            _loc4_ = param1["beforeOrientation"];
            _loc5_ = param1["afterOrientation"];
            ...
            {
               _loc6_ = stage ? stage.stageHeight / this.scaleFactor : height;
               _loc7_ = width;
            }
      ...
      {
         var _loc1_:String = enabled ? "normal" : "disabled";
         if(this.controlBarGroup)
         {
