package spark.components
{
   ...
   public class RichEditableText extends UIComponent implements IFocusManagerComponent, IIMESupport, ISystemCursorClient, IViewport, IEditableText
   {
      ...
      private static function initClass() : void
      {
         ...
         GlobalSettings.tlf_internal::enableDefaultTabStops = !Configuration.tlf_internal::playerEnablesArgoFeatures;
      ...
      {
         if(RichEditableText.mx_internal::createAccessibilityImplementation != null)
         {
      ...
      override protected function commitProperties() : void
      {
         ...
         var _loc4_:ISelectionManager = null;
         ...
         {
            _loc1_ = this._selectionAnchorPosition;
            _loc2_ = this._selectionActivePosition;
            if(this.displayAsPassword)
            {
            ...
            if(this.editingMode != EditingMode.READ_ONLY)
            {
               _loc4_ = this._textContainerManager.beginInteraction();
      ...
      public function getFormatOfRange(param1:Vector.<String> = null, param2:int = -1, param3:int = -1) : TextLayoutFormat
      {
         ...
         for each(_loc6_ in param1)
         {
            ...
            _loc7_ = _loc5_[_loc6_].category;
            if(_loc7_ == Category.CONTAINER && Boolean(_loc11_))
            {
      ...
      private function calculateFontMetrics() : void
      {
         ...
         var _loc6_:ISWFContext = ISWFContext(this.mx_internal::embeddedFontContext);
         if(_loc6_)
         {
      ...
      private function textContainerManager_flowOperationBeginHandler(param1:FlowOperationEvent) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc9_:FlowTextOperation = null;
         var _loc10_:TextOperationEvent = null;
         ...
         else if(!(_loc2_ is PasteOperation))
         {
            ...
            {
               _loc9_ = FlowTextOperation(_loc2_);
               if(_loc9_.absoluteStart == _loc9_.absoluteEnd)
               {
                  param1.preventDefault();
                  return;
               }
         ...
         {
            _loc10_ = new TextOperationEvent(TextOperationEvent.CHANGING);
            _loc10_.operation = _loc2_;
