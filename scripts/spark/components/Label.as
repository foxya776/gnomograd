package spark.components
{
   ...
   public class Label extends TextBase
   {
      ...
      override mx_internal function composeTextLines(param1:Number = NaN, param2:Number = NaN) : Boolean
      {
         ...
         if(Boolean(text != null && text.length > 0) && Boolean(maxDisplayedLines) && !this.doesComposedTextFit(param2,param1,_loc3_,maxDisplayedLines,_loc4_))
         {
      ...
      private function createTextLinesFromTextBlock(param1:TextBlock, param2:Vector.<DisplayObject>, param3:Rectangle) : Boolean
      {
         ...
         var _loc19_:Number = _loc5_ == "explicit" ? TextLine.MAX_LINE_WIDTH : _loc16_;
         ...
         var _loc32_:Boolean = _loc12_ == "center";
      ...
      private function doesComposedTextFit(param1:Number, param2:Number, param3:Boolean, param4:int, param5:String) : Boolean
      {
         ...
         if(mx_internal::textLines.length <= 1 || isNaN(param1))
         {
            return true;
         }
         var _loc6_:TextLine = TextLine(mx_internal::textLines[mx_internal::textLines.length - 1]);
      ...
      private function truncateText(param1:Number, param2:Number, param3:String) : void
      {
         ...
         if(_loc6_ + 1 < mx_internal::textLines.length)
         {
            _loc6_++;
            _loc7_ = true;
         }
      ...
      private function truncateExplicitLineBreakText(param1:Number, param2:Number) : void
      {
         ...
         this.releaseLinesFromTextBlock();
         var _loc5_:int = int(mx_internal::textLines.length);
         var _loc6_:int = 0;
         while(_loc6_ < _loc5_)
         {
            _loc7_ = mx_internal::textLines[_loc6_] as TextLine;
            if(_loc7_.x + _loc7_.width > param1)
            {
               ...
               while(--_loc8_ > 0)
               {
                  ...
                  _loc9_ = _loc9_ + mx_internal::truncationIndicatorResource;
      ...
      private function computeLastAllowedLineIndex(param1:Number, param2:int) : int
      {
         ...
         var _loc3_:* = int(mx_internal::textLines.length - 1);
         if(_loc3_ < 0)
         {
            return _loc3_;
         }
         if(!isNaN(param1))
         {
            while(true)
            {
               _loc4_ = TextLine(mx_internal::textLines[_loc3_]);
      ...
      private function getNextTruncationPosition(param1:int, param2:int) : int
      {
         ...
         while(!(param2 >= _loc3_.textBlockBeginIndex && param2 < _loc3_.textBlockBeginIndex + _loc3_.rawTextLength))
         {
            ...
            else if(++param1 >= mx_internal::textLines.length)
            {
               return param2;
            }
