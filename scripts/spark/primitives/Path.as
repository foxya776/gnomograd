package spark.primitives
{
   ...
   public class Path extends FilledElement
   {
      ...
      {
         if(Boolean(this._boundingBoxCached) && Boolean(this._boundingBoxWidthParamCached == param1) && this._boundingBoxHeightParamCached == param2)
         {
            ...
            if(Boolean(param3 && this._boundingBoxMatrixCached && param3.a == this._boundingBoxMatrixCached.a && param3.b == this._boundingBoxMatrixCached.b) && Boolean(param3.c == this._boundingBoxMatrixCached.c) && param3.d == this._boundingBoxMatrixCached.d)
            {
      ...
      mx_internal function computeBoundsWithStroke(param1:Number, param2:Number, param3:Matrix) : Rectangle
      {
         ...
         var _loc5_:Number = _loc4_.width == 0 ? 1 : param1 / _loc4_.width;
         ...
         var _loc13_:int = int(_loc10_.length);
         var _loc14_:int = 0;
      ...
      override public function getLayoutBoundsX(param1:Boolean = true) : Number
      {
         ...
         if(!_loc2_ && !stroke)
         {
            ...
            _loc4_ = _loc3_.width == 0 || mx_internal::_width == 0 ? 1 : mx_internal::_width / _loc3_.width;
      ...
      override public function getLayoutBoundsY(param1:Boolean = true) : Number
      {
         ...
         if(!_loc2_ && !stroke)
         {
            ...
            _loc3_ = this.getBounds();
            _loc4_ = _loc3_.height == 0 || mx_internal::_height == 0 ? 1 : mx_internal::_height / _loc3_.height;
...
class PathSegmentsCollection
{
   ...
   public function PathSegmentsCollection(param1:String)
   {
...
class LineSegment extends PathSegment
{
   ...
   public function LineSegment(param1:Number = 0, param2:Number = 0)
   {
      super(param1,param2);
   }
   ...
   override public function getBoundingBox(param1:PathSegment, param2:Number, param3:Number, param4:Matrix, param5:Rectangle) : Rectangle
   {
      ...
      _loc8_ = MatrixUtil.transformPoint(param1 ? param1.x * param2 : 0,param1 ? param1.y * param3 : 0,param4);
...
class MoveSegment extends PathSegment
{
   ...
   public function MoveSegment(param1:Number = 0, param2:Number = 0)
   {
      super(param1,param2);
   }
...
class CubicBezierSegment extends PathSegment
{
   ...
   public function CubicBezierSegment(param1:Number = 0, param2:Number = 0, param3:Number = 0, param4:Number = 0, param5:Number = 0, param6:Number = 0)
   {
      super(param5,param6);
...
class QuadraticBezierSegment extends PathSegment
{
   ...
   public function QuadraticBezierSegment(param1:Number = 0, param2:Number = 0, param3:Number = 0, param4:Number = 0)
   {
      super(param3,param4);
      this.control1X = param1;
      this.control1Y = param2;
