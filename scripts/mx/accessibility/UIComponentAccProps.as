package mx.accessibility
{
   ...
   public class UIComponentAccProps extends AccessibilityProperties
   {
      ...
      public function UIComponentAccProps(param1:UIComponent)
      {
         ...
         {
            if(!param1.accessibilityProperties || Boolean(param1.accessibilityProperties) && Boolean(!param1.accessibilityProperties.name))
            {
      ...
      mx_internal static function componentShouldBeSilent(param1:UIComponent) : Boolean
      {
         ...
         var _loc4_:Class = Class(AccImpl.mx_internal::getDefinition("spark.components.Image",param1.moduleFactory));
         if(!_loc4_)
         {
            return false;
         }
      ...
      protected function eventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case "toolTipChanged":
               ...
               if(Boolean(this.master.toolTip) && this.master.toolTip.length != 0)
               {
                  if(!this.master.accessibilityProperties || Boolean(this.master.accessibilityProperties) && Boolean(!this.master.accessibilityProperties.name))
                  {
                     if(!name)
                     {
                        name = "";
