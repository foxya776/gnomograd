package mx.graphics
{
   ...
   public class RadialGradient extends GradientBase implements IFill
   {
      ...
      {
         return compoundTransform ? compoundTransform.scaleX : this._scaleX;
      }
      ...
      {
         return compoundTransform ? compoundTransform.scaleY : this._scaleY;
      }
      ...
      public function begin(param1:Graphics, param2:Rectangle, param3:Point) : void
      {
         ...
         if(!compoundTransform)
         {
            ...
            commonMatrix.rotate(!isNaN(mx_internal::_angle) ? mx_internal::_angle : mx_internal::rotationInRadians);
