package mx.graphics
{
   ...
   public class GradientBase extends EventDispatcher
   {
      ...
      {
         return this.mx_internal::_angle / Math.PI * 180;
      }
      
      public function set angle(param1:Number) : void
      {
         var _loc2_:Number = this.mx_internal::_angle;
         this.mx_internal::_angle = param1 / 180 * Math.PI;
      ...
      private function processEntries() : void
      {
         ...
         var _loc3_:int = int(this._entries.length);
         _loc2_ = 0;
         while(_loc2_ < _loc3_)
         {
            ...
            this.mx_internal::ratios.push(_loc4_.ratio * _loc1_);
            _loc2_++;
         }
