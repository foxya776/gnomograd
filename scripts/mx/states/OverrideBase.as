package mx.states
{
   ...
   public class OverrideBase extends OnDemandEventDispatcher implements IOverride
   {
      ...
      protected function enableBindings(param1:Object, param2:UIComponent, param3:String, param4:Boolean = true) : void
      {
         ...
         if(Boolean(this.isBaseValueDataBound && param1) && Boolean(param2) && Boolean(param3))
         {
            _loc5_ = param1.hasOwnProperty("document") ? param1.document : null;
            _loc5_ = !_loc5_ && param2.hasOwnProperty("document") ? param2.document : _loc5_;
            _loc6_ = param1.hasOwnProperty("id") ? param1.id : null;
            _loc6_ = !_loc6_ && param1.hasOwnProperty("name") ? param1.name : _loc6_;
