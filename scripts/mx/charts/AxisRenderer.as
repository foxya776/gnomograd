package mx.charts
{
   ...
   public class AxisRenderer extends DualStyleObject implements IAxisRenderer
   {
      ...
      {
         super();
         var _loc1_:Class = this.getLabelClass();
         textFieldFactory = new ContextualClassFactory(_loc1_,moduleFactory);
         this._labelCache = new InstanceCache(_loc1_,this);
      ...
      protected function get chart() : ChartBase
      {
         ...
         while(!(_loc1_ is ChartBase) && Boolean(_loc1_))
         {
      ...
      public function set gutters(param1:Rectangle) : void
      {
         ...
         if(Boolean(this._gutters && this._gutters.left == _loc2_.left && this._gutters.right == _loc2_.right) && Boolean(this._gutters.top == _loc2_.top) && this._gutters.bottom == _loc2_.bottom)
         {
      ...
      private function initStyles() : Boolean
      {
         ...
         axisRendererStyle = HaloDefaults.createSelector("mx.charts.AxisRenderer",styleManager);
         ...
         vaxisRendererStyle = HaloDefaults.createSelector(".verticalAxisStyle",styleManager);
         ...
         blockNumeric = HaloDefaults.createSelector(".blockNumericAxis",styleManager);
         ...
         linedNumeric = HaloDefaults.createSelector(".linedNumericAxis",styleManager);
         ...
         dashedNumeric = HaloDefaults.createSelector(".dashedNumericAxis",styleManager);
         ...
         blockCategory = HaloDefaults.createSelector(".blockCategoryAxis",styleManager);
         ...
         hangingCategory = HaloDefaults.createSelector(".hangingCategoryAxis",styleManager);
         ...
         dashedCategory = HaloDefaults.createSelector(".dashedCategoryAxis",styleManager);
      ...
      override protected function measure() : void
      {
         ...
         _loc1_ += this.tickSize(_loc5_);
         _loc1_ += getStyle("labelGap");
         _loc1_ += Number(_loc5_ == true && Boolean(_loc6_) ? _loc6_.weight : 0);
         var _loc7_:Number = 0;
         var _loc8_:Number = 1;
      ...
      public function adjustGutters(param1:Rectangle, param2:Object) : Rectangle
      {
         ...
         _loc8_ += this.tickSize(_loc12_);
         _loc8_ = _loc8_ + getStyle("labelGap");
         _loc8_ = _loc8_ + Number(_loc12_ == true && Boolean(_loc3_) ? _loc3_.weight : 0);
         ...
         if(_loc10_)
         {
            ...
            _loc21_ = int(this._labels.length);
            if(this._labelPlacement.rotation == 0)
            {
               if(this._labelPlacement.staggered)
               {
                  _loc8_ += 2 * _loc20_.height * this._labelPlacement.scale;
               }
               else
               {
                  _loc8_ += this._maxLabelHeight * this._labelPlacement.scale;
               }
            }
            else
            {
               ...
               _loc25_ = 0;
               _loc6_ = Number(this._labelPlacement.scale);
               _loc26_ = 0;
      ...
      private function renderTitle() : void
      {
         ...
         if(Boolean(!this._titleField) || Boolean(getQualifiedClassName(this._titleField) == "mx.charts.chartClasses::ChartLabel" && this._titleRenderer) || getQualifiedClassName(this._titleField) != "mx.charts.chartClasses::ChartLabel" && !this._titleRenderer)
         {
            if(this._titleField)
            {
      ...
      private function getLabelClass() : Class
      {
         ...
         if(labelClass == null)
         {
            try
            {
               labelClass = Class(ApplicationDomain.currentDomain.getDefinition("spark.components::Label"));
            }
            catch(e:Error)
            {
               labelClass = Class(ApplicationDomain.currentDomain.getDefinition("mx.controls::Label"));
            }
         }
         return labelClass;
      }
      ...
      private function calcRotationAndSpacing(param1:Number, param2:Number, param3:Number, param4:Rectangle, param5:Object) : Object
      {
         ...
         var _loc9_:int = int(this._labels.length);
         if(_loc9_ == 0)
         {
            return {
               "rotation":0,
         ...
         {
            _loc13_ = _loc12_ = _loc11_ != false && _loc11_ != "false";
         }
         ...
         if(_loc13_)
         {
            ...
            _loc42_ = true;
            _loc43_ = 0;
            _loc9_ = int(this._labels.length);
            if(this._horizontal)
            {
               if(_loc9_ > 0)
               {
            ...
            _loc44_ = 1;
            while(_loc44_ < _loc9_)
            {
               _loc33_ = this._labels[_loc38_ + _loc39_ * _loc44_];
      ...
      private function calcVerticalSpacing(param1:Number, param2:Object, param3:Number, param4:ARLabelData, param5:ARLabelData, param6:Boolean) : Object
      {
         ...
         var _loc14_:int = int(this._labels.length);
         if(param6)
         {
            _loc17_ = 0;
            _loc19_ = true;
            do
            {
               ...
               _loc14_ = int(this._labels.length);
               _loc23_ = 1;
      ...
      private function calcHorizontalSpacing(param1:Number, param2:Object, param3:Number, param4:ARLabelData, param5:ARLabelData, param6:Boolean, param7:Object, param8:Number) : Object
      {
         ...
         var _loc26_:Object = null;
         var _loc27_:int = 0;
         var _loc9_:Number = Number(param2.horizontalleftGutter);
         var _loc10_:Number = Number(param2.horizontalrightGutter);
      ...
      private function calcStaggeredSpacing(param1:Number, param2:Object, param3:Number, param4:ARLabelData, param5:ARLabelData, param6:Boolean, param7:Object) : Object
      {
         ...
         var _loc16_:Number = NaN;
         var _loc17_:Number = NaN;
         var _loc8_:Number = Number(param2.horizontalleftGutter);
         var _loc9_:Number = Number(param2.horizontalrightGutter);
         ...
         var _loc13_:int = int(this._labels.length);
         var _loc14_:int = 2;
      ...
      private function measureAngledGutters(param1:Number, param2:Number, param3:Number, param4:ARLabelData, param5:Number, param6:Number, param7:Object) : Object
      {
         ...
         var _loc21_:int = int(this._labels.length);
         _loc22_ = 1;
      ...
      private function updateCaches() : void
      {
         ...
         if(this._cacheDirty)
         {
            ...
            {
               this._labelCache.properties = {"styleName":this};
            }
            else
            {
      ...
      private function drawLabels(param1:Boolean) : Number
      {
         ...
         var _loc10_:Number = Number(this._labelPlacement.scale);
         var _loc11_:int = int(this._labels.length);
         ...
         else if(this._labelPlacement.rotation > 0)
         {
            ...
            else
            {
               ...
               try
               {
                  ...
                  {
                     _loc24_ = Class(ApplicationDomain.currentDomain.getDefinition("spark.components.Label"));
                  }
               }
               catch(e:Error)
               {
               ...
               while(_loc15_ < _loc11_)
               {
                  ...
                  _loc6_.instance.x = this._gutters.left + _loc16_ * _loc6_.position - _loc6_.width * _loc10_ * _loc22_ - _loc6_.height * _loc18_ * _loc10_ * _loc23_;
                  _loc6_.instance.y = _loc4_ + _loc6_.width * _loc10_ * _loc23_ - _loc6_.height * _loc18_ * _loc10_ * _loc22_;
                  if(Boolean(_loc24_) && Boolean(_loc6_.instance is _loc24_) && layoutDirection == LayoutDirection.RTL)
                  {
                     _loc6_.instance.x -= _loc6_.width;
                     _loc6_.instance.y = _loc4_;
                  }
                  _loc15_++;
               }
               _loc3_ = _loc4_ + this._maxRotatedLabelHeight;
      ...
      private function renderLabels() : void
      {
         ...
         try
         {
            if(ApplicationDomain.currentDomain.getDefinition("spark.components.Label"))
            {
               _loc6_ = Class(ApplicationDomain.currentDomain.getDefinition("spark.components.Label"));
            }
         }
         catch(e:Error)
         {
         ...
         else
         {
            ...
            _loc7_ = int(this._labels.length);
            if(!this._labelRenderer)
            {
               _loc2_ = 0;
               while(_loc2_ < _loc7_)
               {
                  ...
                  _loc8_ = _loc3_.instance;
                  _loc8_.text = _loc3_.text;
                  if(Boolean(_loc6_) && _loc3_.instance is _loc6_)
                  {
                     _loc8_.setStyle("paddingTop",5);
                     _loc8_.setStyle("paddingLeft",2);
                  }
      ...
      private function drawAxis(param1:Boolean) : void
      {
         ...
         if(param1 == true)
         {
            ...
            _loc5_ = 0;
            _loc6_ = 0;
            if(this._horizontal && Boolean(this._otherAxes))
            {
               _loc7_ = int(this._otherAxes.length);
               _loc8_ = 0;
               while(_loc8_ < _loc7_)
               {
                  ...
                  if(Boolean(_loc10_) && _loc11_)
                  {
                     if(_loc12_ == "right" || _loc12_ == "top")
                     {
                        _loc6_ += _loc10_.weight;
                     }
                     else
                     {
                        _loc5_ += _loc10_.weight;
                     }
                  }
                  _loc8_++;
               }
      ...
      private function drawTicks(param1:Boolean) : Number
      {
         ...
         var _loc17_:int = int(this._ticks.length);
      ...
      private function processAxisLabels(param1:AxisLabelSet) : Boolean
      {
         ...
         var _loc3_:Array = [];
         var _loc4_:Boolean = this._labelRenderer != null;
         ++this._supressInvalidations;
         _loc2_ = int(param1.labels.length);
         this._labels = [];
         _loc5_ = 0;
         while(_loc5_ < _loc2_)
         {
         ...
         if(!_loc4_)
         {
            ...
            _loc11_.embedFonts = Boolean(_loc10_) && _loc10_.isFontFaceEmbedded(_loc12_);
         }
         else
         {
      ...
      {
         AxisBase(this._axis).mx_internal::highlightElements(false);
      }
      
      private function mouseOverHandler(param1:MouseEvent) : void
      {
         AxisBase(this._axis).mx_internal::highlightElements(true);
      }
   }
}
...
class ARLabelData
{
   ...
   public function ARLabelData(param1:AxisLabel, param2:Number, param3:String)
   {
      super();
      this.value = param1;
