   ...
   public class DualStyleObject extends UIComponent
   {
      ...
      override mx_internal function initProtoChain() : void
      {
         ...
         while(_loc7_ < _loc6_)
         {
            ...
            _loc8_ = _loc9_.mx_internal::addStyleToProtoChain(_loc8_,this);
            _loc3_ = _loc9_.mx_internal::addStyleToProtoChain(_loc3_,this);
            if(_loc9_.mx_internal::effects)
            {
               registerEffects(_loc9_.mx_internal::effects);
            }
            _loc7_++;
         }
         if(_loc2_)
         {
            _loc8_ = _loc2_.mx_internal::addStyleToProtoChain(_loc8_,this);
            _loc3_ = _loc2_.mx_internal::addStyleToProtoChain(_loc3_,this);
            if(_loc2_.mx_internal::effects)
            {
               registerEffects(_loc2_.mx_internal::effects);
            }
         }
         if(_loc1_)
         {
            _loc8_ = _loc1_.mx_internal::addStyleToProtoChain(_loc8_,this);
            _loc3_ = _loc1_.mx_internal::addStyleToProtoChain(_loc3_,this);
            if(_loc1_.mx_internal::effects)
            {
               registerEffects(_loc1_.mx_internal::effects);
            }
         }
         inheritingStyles = styleDeclaration ? styleDeclaration.mx_internal::addStyleToProtoChain(_loc8_,this) : _loc8_;
         nonInheritingStyles = styleDeclaration ? styleDeclaration.mx_internal::addStyleToProtoChain(_loc3_,this) : _loc3_;
      }
   }
}
