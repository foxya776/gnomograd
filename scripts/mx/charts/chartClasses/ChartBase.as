package mx.charts.chartClasses
{
   ...
   public class ChartBase extends UIComponent implements IFocusManagerComponent
   {
      ...
      protected function setChartState(param1:uint) : void
      {
         ...
         var _loc3_:int = int(this.allElements.length);
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
      ...
      {
         this.mx_internal::setDescription(param1);
         tabEnabled = true;
      }
      ...
      public function get legendData() : Array
      {
         ...
         var _loc1_:Array = [];
         var _loc2_:int = int(this.allElements.length);
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
      ...
      public function get selectedChartItems() : Array
      {
         ...
         var _loc5_:int = 0;
         var _loc1_:Array = [];
         var _loc2_:int = int(this.series.length);
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
            _loc4_ = int(this.series[_loc3_].selectedItems.length);
            _loc5_ = 0;
            while(_loc5_ < _loc4_)
            {
      ...
      private function initStyles() : Boolean
      {
         ...
         selector = HaloDefaults.createSelector("mx.charts.chartClasses.ChartBase",styleManager);
      ...
      override protected function commitProperties() : void
      {
         ...
         {
            this.mx_internal::updateSeries();
            this._selectedSeries = null;
            this._bSeriesDirty = false;
         }
         this.mx_internal::updateSeriesStyles();
         if(this._bDataDirty)
         {
            this.mx_internal::updateData();
            this._bDataDirty = false;
         }
         if(this._childOrderDirty)
         {
            this.mx_internal::updateChildOrder();
      ...
      public function findDataPoints(param1:Number, param2:Number) : Array
      {
         ...
         _loc4_ = int(this.allElements.length);
         _loc5_ = int(_loc4_ - 1);
         while(_loc5_ >= 0)
         {
         ...
         while(_loc5_ < _loc4_)
         {
            _loc3_[_loc5_].x += this._seriesHolder.x;
            _loc3_[_loc5_].y += this._seriesHolder.y;
            _loc5_++;
         }
         return _loc3_;
      }
      ...
      public function getAllDataPoints() : Array
      {
         ...
         var _loc1_:Array = [];
         _loc2_ = int(this.allElements.length);
         _loc3_ = int(_loc2_ - 1);
         while(_loc3_ >= 0)
         {
         ...
         while(_loc3_ < _loc2_)
         {
            _loc1_[_loc3_].x += this._seriesHolder.x;
            _loc1_[_loc3_].y += this._seriesHolder.y;
            _loc3_++;
         }
         return _loc1_;
      }
      ...
      public function getItemsInRegion(param1:Rectangle) : Array
      {
         ...
         if(this._transforms)
         {
            _loc3_ = int(this._transforms.length);
            _loc4_ = 0;
            while(_loc4_ < _loc3_)
            {
      ...
      private function processRollEvents(param1:Array, param2:MouseEvent) : void
      {
         ...
         var _loc7_:int = int(this._currentHitSet.length);
         var _loc8_:int = 0;
         var _loc9_:int = 0;
         ...
         if(param2.type == MouseEvent.MOUSE_DOWN)
         {
            ...
            {
               this.mx_internal::selectItem(param1[0].chartItem,param2);
            }
         }
         if(param2.type == MouseEvent.MOUSE_UP)
         {
            ...
            {
               this.mx_internal::selectItem(this._mouseDownItem,param2);
            }
         ...
         if(param2.type != MouseEvent.MOUSE_DOWN && param2.type != MouseEvent.MOUSE_UP)
         {
            ...
            {
               this.mx_internal::rollOverItem(param1,_loc3_);
            }
         }
         if(param2.type == MouseEvent.MOUSE_MOVE)
         {
            ...
            if(this._dragEnabled && this._mouseDown && !DragManager.isDragging && (Math.abs(this._mouseDownPoint.x - _loc10_.x) > mx_internal::DRAG_THRESHOLD || Math.abs(this._mouseDownPoint.y - _loc10_.y) > mx_internal::DRAG_THRESHOLD))
            {
      ...
      mx_internal function selectItem(param1:ChartItem, param2:MouseEvent) : void
      {
         ...
         if(this._selectionMode == "multiple" && param2.shiftKey && Boolean(this._anchorItem))
         {
            this.mx_internal::handleShift(param1);
            _loc4_ = true;
         ...
         else if(this._selectionMode != "none" && _loc3_.selectable)
         {
            ...
            if(_loc5_)
            {
               if(!this._selectedSeries)
               {
                  this.mx_internal::setChartItemsToDisabled();
               }
               else if(this._selectionMode == "single")
               {
                  ...
                  {
                     this._selectedSeries.mx_internal::removeItemfromSelection(this._selectedSeries.selectedItem);
                  }
               }
               ...
               _loc3_.mx_internal::addItemtoSelection(param1);
               this._selectedSeries = _loc3_;
               _loc4_ = true;
            }
            else if(this._selectionMode == "multiple")
            {
               if(param2.ctrlKey)
               {
                  _loc3_.mx_internal::removeItemfromSelection(param1);
                  if(this._selectedSeries.selectedItems.length == 0)
                  {
                     _loc8_ = _loc3_;
                     _loc8_ = this.mx_internal::getSelectedSeries(_loc3_);
                     if(!_loc8_)
                     {
                        this.clearSelection();
                     }
               ...
               else if(_loc3_ == this._selectedSeries && !this.mx_internal::getSelectedSeries(_loc3_) && this._selectedSeries.selectedItems.length == 1)
               {
                  _loc4_ = false;
               }
               else
      ...
      mx_internal function getSelectedSeries(param1:Series) : Series
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         var _loc2_:int = int(this._transforms.length);
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
            _loc4_ = int(this._transforms[_loc3_].elements.length);
            _loc5_ = 0;
            while(_loc5_ < _loc4_)
            {
      ...
      mx_internal function setChartItemsToDisabled() : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc1_:int = int(this._transforms.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = int(this._transforms[_loc2_].elements.length);
            _loc4_ = 0;
            while(_loc4_ < _loc3_)
            {
      ...
      public function clearSelection() : void
      {
         ...
         if(this._selectedSeries)
         {
            _loc1_ = int(this._transforms.length);
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               _loc3_ = int(this._transforms[_loc2_].elements.length);
      ...
      mx_internal function selectSpecificChartItems(param1:Array) : void
      {
         ...
         while(_loc7_ < _loc6_)
         {
            ...
            if(_loc2_.selectable)
            {
               ...
               if(this._selectionMode == "single" && Boolean(this._selectedSeries))
               {
                  this._selectedSeries.mx_internal::removeItemfromSelection(this._selectedSeries.selectedItem);
               }
               if(_loc2_.selectedItems.indexOf(param1[_loc7_]) == -1)
               {
                  _loc2_.mx_internal::addItemtoSelection(param1[_loc7_]);
               }
      ...
      mx_internal function seriesSelectionChanged(param1:Series, param2:Array) : void
      {
         ...
         {
            param1.mx_internal::clearSeriesItemsState(true,ChartItem.DISABLED);
         }
         if(param2.length == 0)
         {
            _loc3_ = this.mx_internal::getSelectedSeries(param1);
            if(!_loc3_)
            {
               this.clearSelection();
            }
         ...
         else
         {
            ...
            {
               if(Boolean(this._selectedSeries) && this._selectedSeries != param1)
               {
                  this._selectedSeries.mx_internal::removeItemfromSelection(this._selectedSeries.selectedItem);
               }
               param1.mx_internal::addItemtoSelection(param2[param2.length - 1]);
            }
            else
            {
               ...
               while(_loc5_ < _loc4_)
               {
                  param1.mx_internal::addItemtoSelection(param2[_loc5_]);
                  _loc5_++;
               }
            }
      ...
      mx_internal function handleSpace(param1:KeyboardEvent) : void
      {
         ...
         if(_loc2_.selectable)
         {
            if(_loc2_.selectedItems.indexOf(this._caretItem) != -1)
            {
               if(_loc4_)
               {
                  _loc2_.mx_internal::removeItemfromSelection(this._caretItem);
                  ...
                  {
                     _loc6_ = _loc2_;
                     _loc6_ = this.mx_internal::getSelectedSeries(_loc2_);
                     if(!_loc6_)
                     {
                        this.clearSelection();
                     }
            ...
            else
            {
               ...
               this._selectedSeries = _loc2_;
               this._selectedSeries.mx_internal::addItemtoSelection(this._caretItem);
               this._caretItem.currentState = ChartItem.FOCUSEDSELECTED;
               _loc3_ = true;
            }
         }
         if(_loc3_)
         {
            if(Boolean(this._selectedSeries) && (!_loc5_ || !this._anchorItem))
            {
      ...
      mx_internal function handleNavigation(param1:ChartItem, param2:KeyboardEvent) : void
      {
            ...
            else
            {
               ...
               else
               {
                  ...
                  if(Series(this._anchorItem.element) == _loc3_)
                  {
                     ...
                     {
                        _loc3_.mx_internal::addItemtoSelection(_loc3_.items[_loc12_]);
                        _loc12_++;
                     }
                  }
                  else
                  {
                     Series(this._anchorItem.element).mx_internal::addItemtoSelection(this._anchorItem);
                     _loc3_.mx_internal::addItemtoSelection(param1);
                  }
               }
               this._selectedSeries = _loc3_;
         ...
         if(_loc5_ && Boolean(this._selectedSeries))
         {
            if(!_loc7_ || Boolean(this._selectedSeries) && Boolean(!this._anchorItem))
            {
               this._anchorItem = this._selectedSeries.selectedItem;
            }
            dispatchEvent(new ChartItemEvent(ChartItemEvent.CHANGE,null,null,this));
      ...
      private function selectRectangleRegion(param1:Rectangle, param2:Boolean = false) : void
      {
         ...
         this.mx_internal::selectSpecificChartItems(_loc3_);
      }
      ...
      private function findItemsInRegionFromElements(param1:DataTransform, param2:Rectangle) : Array
      {
         ...
         while(_loc6_ < _loc5_)
         {
            if(Boolean(_loc3_[_loc6_] is Series) && Boolean(_loc3_[_loc6_].selectable) && Boolean(_loc3_[_loc6_].visible))
            {
      ...
      public function updateAllDataTips() : void
      {
         ...
         else
         {
            if(!this._allTipCache)
            {
               ...
               this._allTipCache = new InstanceCache(_loc4_,this,-1,moduleFactory);
      ...
      private function updateDataTipToMatchHitSet(param1:Array) : void
      {
         ...
         else
         {
            ...
            {
               _loc4_ = getStyle("dataTipRenderer");
               this._tipCache = new InstanceCache(_loc4_,systemManager.toolTipChildren,-1,moduleFactory);
      ...
      protected function positionAllDataTips(param1:Array) : void
      {
         ...
         var _loc39_:int = 0;
         var _loc40_:uint = 0;
         var _loc2_:int = this._allTipCache ? this._allTipCache.count : 0;
         ...
         if(_loc8_.length > 0)
         {
            ...
            _loc11_ = Number(_loc8_[0].gx);
            _loc12_ = Number(_loc8_[_loc8_.length - 1].gx);
         ...
         while(_loc26_ && _loc27_ <= 2)
         {
            ...
            while(true)
            {
               ...
               while(_loc23_ < _loc5_.length && _loc5_[_loc23_].gy - TOOLTIP_TARGET_RADIUS < _loc36_.py + _loc36_.height)
               {
                  ...
                  {
                     _loc37_ = false;
                     _loc12_ = Number(_loc5_[_loc23_].gx);
                  }
                  if(_loc5_[_loc23_].gx <= _loc11_)
                  {
                     _loc38_ = false;
                     _loc11_ = Number(_loc5_[_loc23_].gx);
                  }
                  _loc23_++;
               }
               if(_loc37_ || _loc38_)
      ...
      protected function positionDataTips() : void
      {
         ...
         var _loc40_:int = 0;
         var _loc41_:uint = 0;
         var _loc1_:int = this._tipCache ? this._tipCache.count : 0;
         ...
         while(_loc8_ < _loc1_)
         {
            ...
            {
               _loc32_ = FlexGlobals.topLevelApplication.localToGlobal(new Point(0,0));
               _loc9_ = new TipPositionData(_loc28_,_loc27_,_loc20_.x,_loc20_.y,_loc29_.x - _loc32_.x,_loc29_.y - _loc32_.y);
            }
            else
            {
         ...
         if(_loc7_.length > 0)
         {
            ...
            _loc10_ = Number(_loc7_[0].gx);
            _loc11_ = Number(_loc7_[_loc7_.length - 1].gx);
            _loc33_ = new Point(4,4);
            _loc34_ = new Point(screen.width - 4,screen.height - 4);
            _loc8_ = 0;
            _loc35_ = Math.floor(_loc7_.length / 2);
            if(_loc5_.length > _loc6_.length)
            {
               _loc35_ = Math.max(0,_loc35_ - (_loc5_.length - _loc6_.length));
            }
            else if(_loc6_.length > _loc5_.length)
            {
               _loc35_ = Math.min(_loc7_.length,_loc35_ + (_loc6_.length - _loc5_.length));
            }
            if(_loc7_.length == 1 && layoutDirection == LayoutDirection.RTL)
            {
               _loc6_ = _loc6_.concat(_loc7_.slice(0,_loc35_));
               _loc5_ = _loc5_.concat(_loc7_.slice(_loc35_,_loc7_.length));
            }
            else
            {
               _loc5_ = _loc5_.concat(_loc7_.slice(0,_loc35_));
               _loc6_ = _loc6_.concat(_loc7_.slice(_loc35_,_loc7_.length));
            }
         }
         _loc6_.sortOn("gy");
         ...
         while(_loc25_ && _loc26_ <= 2)
         {
            ...
            while(true)
            {
               ...
               _loc36_ = _loc4_[_loc8_];
               _loc37_ = false;
               _loc38_ = false;
               while(_loc21_ < _loc4_.length && _loc4_[_loc21_].gy + TOOLTIP_TARGET_RADIUS < _loc36_.py)
               {
               ...
               while(_loc22_ < _loc4_.length && _loc4_[_loc22_].gy - TOOLTIP_TARGET_RADIUS < _loc36_.py + _loc36_.height)
               {
                  if(_loc4_[_loc22_].gx >= _loc11_)
                  {
                     _loc37_ = false;
                     _loc11_ = Number(_loc4_[_loc22_].gx);
                  }
                  if(_loc4_[_loc22_].gx <= _loc10_)
                  {
                     _loc38_ = false;
                     _loc10_ = Number(_loc4_[_loc22_].gx);
                  }
                  _loc22_++;
               }
               if(_loc37_ || _loc38_)
               {
                  ...
                  _loc10_ = Infinity;
                  _loc40_ = _loc21_;
                  while(_loc40_ < _loc22_)
                  {
                     _loc11_ = Math.max(_loc11_,_loc4_[_loc40_].gx);
                     _loc10_ = Math.min(_loc10_,_loc4_[_loc40_].gx);
                     _loc40_++;
                  }
               }
               if(_loc36_.isRight)
               {
                  _loc36_.px = Math.max(_loc36_.px,_loc11_ + TOOLTIP_TARGET_RADIUS);
                  _loc36_.px = Math.max(_loc23_,_loc36_.px);
                  if(_loc36_.px > _loc34_.x - _loc36_.width)
                  {
                     _loc36_.px = _loc34_.x - _loc36_.width;
                     if(_loc24_ > _loc36_.px)
                     {
                        _loc24_ = _loc36_.px;
                        _loc25_ = true;
                     }
               ...
               {
                  _loc36_.px = Math.min(_loc36_.px,_loc10_ - TOOLTIP_TARGET_RADIUS - _loc36_.width);
                  _loc36_.px = Math.min(_loc24_ - _loc36_.width,_loc36_.px);
                  if(_loc36_.px < _loc33_.x)
                  {
                     _loc36_.px = _loc33_.x;
                     if(_loc36_.px + _loc36_.width > _loc23_)
                     {
                        _loc23_ = _loc36_.px + _loc36_.width;
                        _loc25_ = true;
                     }
                  }
               }
               _loc29_.x = _loc36_.px;
               _loc29_.y = _loc36_.py;
               _loc20_ = this.parentApplication.systemManager.getSandboxRoot().globalToLocal(_loc29_);
               _loc39_ = globalToLocal(_loc29_);
               _loc36_.tip.move(_loc20_.x,_loc20_.y);
               if(_loc19_)
               {
                  if(_loc12_ > 1)
                  {
                     if(_loc15_)
                     {
                        ...
                        if(_loc36_.isRight)
                        {
                           _loc3_.moveTo(_loc39_.x,_loc39_.y + _loc36_.height / 2);
                           _loc3_.lineTo(_loc36_.x,_loc39_.y + _loc36_.height / 2);
                           _loc3_.lineTo(_loc36_.x,_loc36_.y);
                        }
                        else
                        {
                           if(layoutDirection == LayoutDirection.RTL)
                           {
                              _loc3_.moveTo(_loc39_.x - _loc36_.width,_loc39_.y + _loc36_.height / 2);
                           }
                           else
                           {
                              _loc3_.moveTo(_loc39_.x + _loc36_.width,_loc39_.y + _loc36_.height / 2);
                  ...
                  _loc41_ = _loc36_.hd.contextColor;
                  _loc3_.lineStyle(1,_loc41_,100);
                  _loc3_.moveTo(_loc36_.x,_loc36_.y);
                  _loc3_.beginFill(16777215,1);
                  _loc3_.drawCircle(_loc36_.x,_loc36_.y,TOOLTIP_TARGET_RADIUS);
                  _loc3_.endFill();
                  _loc3_.beginFill(_loc41_,1);
                  _loc3_.drawCircle(_loc36_.x,_loc36_.y,TOOLTIP_TARGET_INNER_RADIUS);
                  _loc3_.endFill();
               }
               _loc8_++;
            }
      ...
      mx_internal function updateChildOrder() : void
      {
         ...
         _loc1_ = this.mx_internal::updateAxisOrder(_loc1_);
      ...
      mx_internal function updateSeries() : void
      {
         ...
         _loc2_ = int(this.labelElements.numChildren);
         this.mx_internal::removeElements(this._backgroundElementHolder,true);
         this.mx_internal::removeElements(this._seriesFilterer,false);
         this.mx_internal::removeElements(this._annotationElementHolder,true);
         this.mx_internal::addElements(this._backgroundElements,this._transforms[0],this._backgroundElementHolder);
         this.allElements = this._backgroundElements.concat();
         this.mx_internal::addElements(_loc1_,this._transforms[0],this._seriesFilterer);
         ...
         this.mx_internal::addElements(this.labelElements,this._transforms[0],this._annotationElementHolder);
         this.allElements = this.allElements.concat(this.labelElements);
         this.mx_internal::addElements(this._annotationElements,this._transforms[0],this._annotationElementHolder);
      ...
      mx_internal function addElements(param1:Array, param2:DataTransform, param3:UIComponent) : void
      {
         ...
         while(_loc7_ < _loc6_)
         {
            ...
            if((Boolean(_loc5_)) && Boolean(!(_loc5_ is Series)) && !(_loc5_ is IDataCanvas))
            {
      ...
      mx_internal function removeElements(param1:UIComponent, param2:Boolean) : void
      {
         ...
         while(_loc5_ >= _loc4_)
         {
            ...
            if((Boolean(_loc7_)) && !(_loc7_ is Series))
            {
      ...
      mx_internal function updateSeriesStyles() : void
      {
         ...
         if(this._seriesStylesDirty)
         {
            ...
            if(_loc2_)
            {
               _loc3_ = int(this.allElements.length);
               _loc4_ = 0;
               while(_loc4_ < _loc3_)
               {
                  _loc5_ = this.allElements[_loc4_] as IChartElement;
      ...
      mx_internal function updateData() : void
      {
         ...
         {
            this.mx_internal::applyDataProvider(this._dataProvider,this._transforms[0]);
         }
         var _loc1_:uint = this.series.length;
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            this.mx_internal::applyDataProvider(ICollectionView(this.dataProvider),this.series[_loc2_].dataTransform);
            _loc2_++;
         }
      }
      ...
      mx_internal function getNextSeries(param1:Array) : ChartItem
      {
         ...
         {
            _loc3_++;
            if(Boolean(param1[_loc3_].selectable) && Boolean(param1[_loc3_].visible) && param1[_loc3_].items.length > 0)
            {
               _loc2_ = true;
            }
         }
      ...
      mx_internal function getNextSeriesItem(param1:Array) : ChartItem
      {
         ...
         if(!this._caretItem)
         {
            return this.mx_internal::getNextSeries(param1);
         }
      ...
      mx_internal function getPreviousSeriesItem(param1:Array) : ChartItem
      {
         ...
         if(!this._caretItem)
         {
            return this.mx_internal::getPreviousSeries(param1);
         }
         _loc3_ = Series(this._caretItem.element);
         _loc2_ = _loc3_.items.indexOf(this._caretItem);
         if(_loc2_ == 0)
      ...
      private function mouseOverHandler(param1:MouseEvent) : void
      {
         ...
         if(this._tipCache)
         {
            ...
            while(_loc3_ < _loc2_)
            {
               ...
               if(Boolean(param1.relatedObject) && (_loc4_ == param1.relatedObject || _loc4_ is DisplayObjectContainer && (_loc4_ as DisplayObjectContainer).contains(param1.relatedObject)))
               {
                  return;
               }
               _loc3_++;
      ...
      private function mouseClickHandler(param1:MouseEvent) : void
      {
         ...
         var _loc3_:Array = this.findDataPoints(_loc2_.x,_loc2_.y);
         this.processRollEvents(_loc3_,param1);
         if(Boolean(this._currentHitSet) && this._currentHitSet.length > 0)
         {
      ...
      private function regionChangeHandler(param1:RangeEvent) : void
      {
         ...
         if((Boolean(_loc2_) || Boolean(this._selectedSeries)) && !param1.mouseEvent.buttonDown)
         {
...
class TipStack
{
   ...
   public function positionY() : void
   {
      ...
      var _loc1_:Number = Number(this.gy);
      var _loc2_:int = int(this.tips.length);
      var _loc3_:int = 0;
      while(_loc3_ < _loc2_)
      {
...
class TipPositionData
{
   ...
   public function TipPositionData(param1:IFlexDisplayObject, param2:HitData, param3:Number, param4:Number, param5:Number, param6:Number)
   {
      super();
      this.tip = param1;
      this.hd = param2;
...
class RangeEvent extends Event
{
   ...
   public function RangeEvent(param1:String, param2:Rectangle, param3:MouseEvent)
   {
      super(param1);
