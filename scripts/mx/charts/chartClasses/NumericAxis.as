package mx.charts.chartClasses
{
   ...
   public class NumericAxis extends AxisBase implements IAxis
   {
      ...
      {
         var _loc1_:Array = [];
         var _loc2_:int = int(this.labelCache.length);
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
      ...
      private function updateCache(param1:Boolean, param2:Number) : void
      {
         ...
         if(this._regenerateAutoValues)
         {
            ...
            {
               _loc12_ = unitSize / 2;
               this.computedMinimum -= _loc12_;
               this.computedMaximum += _loc12_;
            }
      ...
      private function adjustForMargins(param1:Number) : void
      {
         ...
         if(_loc6_.length > 0 && param1 > 0 && _loc8_)
         {
            if(isNaN(_loc2_))
            {
               _loc2_ = Number(_loc6_[0].value);
            }
            if(isNaN(_loc3_))
            {
               _loc3_ = Number(_loc6_[0].value);
            }
            _loc10_ = param1;
         ...
         if(_loc9_)
         {
            _loc2_ = Number(_loc9_[0]);
            _loc3_ = Number(_loc9_[1]);
         }
         if(isNaN(this.assignedMinimum))
         {
      ...
      private function autoGenerate(param1:Boolean, param2:Number) : void
      {
         ...
         if(this.autoAdjust && this.baseAtZero)
         {
            if(this.direction == "inverted")
            {
               _loc4_ = this.mx_internal::zeroValue;
            }
            else
            {
               _loc3_ = this.mx_internal::zeroValue;
            }
         }
         ...
         if(_loc7_ > 0)
         {
            ...
            while(_loc11_ < _loc7_)
            {
               ...
               this._cachedValuesHaveBounds = this._cachedValuesHaveBounds || Boolean(_loc12_.boundedValues) && _loc12_.boundedValues.length > 0;
               _loc11_++;
            }
         }
         ...
         if(_loc9_)
         {
            _loc3_ = Number(_loc9_[0]);
            _loc4_ = Number(_loc9_[1]);
         }
         if(isNaN(this.assignedMinimum))
         {
