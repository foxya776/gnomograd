package mx.charts.chartClasses
{
   ...
   public class Series extends ChartElement
   {
      ...
      {
         var _loc1_:int = 0;
         _loc1_ = int(this._selectedItems.length);
         if(_loc1_ > 0)
         {
      ...
      {
         var _loc1_:Array = [];
         var _loc2_:int = int(this._selectedItems.length);
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
      ...
      override protected function commitProperties() : void
      {
         ...
         if(Boolean(this._dataTipItems) && Boolean(chart))
         {
         ...
         if(this._selectionDirty)
         {
            ...
            if(this._selectable && Boolean(chart))
            {
               chart.mx_internal::seriesSelectionChanged(this,this._selectionDirtyArray);
            }
         }
      }
      ...
      override public function collectTransitions(param1:Number, param2:Array) : void
      {
         ...
         {
            _loc3_ = EffectManager.mx_internal::createEffectForType(this,"hideData") as Effect;
            if(_loc3_)
            {
         ...
         {
            validateProperties();
            _loc3_ = EffectManager.mx_internal::createEffectForType(this,"showData") as Effect;
            if(_loc3_)
            {
               _loc4_ = _loc3_.createInstance(this);
               if(_loc4_ is SeriesEffectInstance)
      ...
      mx_internal function clearSeriesItemsState(param1:Boolean, param2:String = "none") : void
      {
         ...
         this.mx_internal::setItemsState(param2);
      }
      ...
      private function validateSelection() : void
      {
         ...
         else if(this._selectionDirty == true)
         {
            ...
            if(chart)
            {
               chart.mx_internal::updateKeyboardCache();
            }
         }
      }
      ...
      protected function extractMinMax(param1:Array, param2:String, param3:DataDescription, param4:Boolean = false) : void
      {
         ...
         if(isNaN(param3.min))
         {
            ...
            while(_loc6_ < _loc5_)
            {
               _loc7_ = Number(param1[_loc6_][param2]);
      ...
      protected function extractMinInterval(param1:Array, param2:String, param3:DataDescription) : void
      {
         ...
         while(_loc5_ < _loc4_)
         {
            _loc6_ = Number(param1[_loc5_][param2]);
      ...
      protected function initializeInterpolationData(param1:Array, param2:Array, param3:Object, param4:Class = null, param5:Object = null) : Object
      {
         ...
         while(_loc10_ < _loc8_)
         {
            ...
            for(_loc23_ in param3)
            {
               if(_loc12_)
               {
                  _loc21_ = Number(_loc12_[_loc23_]);
               }
               else
               {
                  _loc21_ = NaN;
               ...
               if(_loc13_)
               {
                  _loc22_ = Number(_loc13_[_loc23_]);
               }
               else
               {
                  _loc22_ = NaN;
            ...
            if(_loc20_)
            {
               ...
               {
                  _loc21_ = Number(_loc18_[_loc23_]);
                  _loc15_[_loc23_] = _loc21_;
                  _loc14_[_loc23_] = _loc21_;
