package mx.charts.chartClasses
{
   ...
   public class ChartLabel extends UIComponent implements IDataRenderer
   {
      ...
      override protected function measure() : void
      {
         ...
         _loc1_ = rotation;
         if(Boolean(parent) && parent.rotation == 90)
         {
            rotation = -90;
         }
         ...
         if(this._label.embedFonts)
         {
            ...
            measuredHeight = this._label.measuredHeight + UITextField.mx_internal::TEXT_HEIGHT_PADDING;
         }
         else
         {
            measuredWidth = this._label.textWidth + 6;
            measuredHeight = this._label.textHeight + UITextField.mx_internal::TEXT_HEIGHT_PADDING;
         }
         rotation = _loc1_;
      }
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         if(Boolean(parent && parent is AxisRenderer) && Boolean(parent.rotation == 90) && this._label.embedFonts == true)
         {
         ...
         else
         {
            ...
            if(Boolean(parent) && Boolean(parent.rotation == 90) && parent is AxisRenderer)
            {
               _loc6_ = AxisRenderer(parent);
               if(_loc6_.getStyle("verticalAxisTitleAlignment") == "vertical" && _loc6_.layoutDirection == LayoutDirection.LTR || _loc6_.getStyle("verticalAxisTitleAlignment") == "flippedVertical" && _loc6_.layoutDirection == LayoutDirection.RTL)
               {
