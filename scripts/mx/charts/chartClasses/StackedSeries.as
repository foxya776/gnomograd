package mx.charts.chartClasses
{
   ...
   public class StackedSeries extends Series
   {
      ...
      override protected function processNewDataProvider(param1:Object) : void
      {
         ...
         var _loc2_:int = int(this._series.length);
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
      ...
      override protected function commitProperties() : void
      {
         ...
         if(Boolean(_loc1_) && _loc1_ is CartesianChart)
         {
            _loc2_ = CartesianChart(_loc1_);
            if(!this._horizontalAxis)
            {
               if(dataTransform.axes[CartesianTransform.HORIZONTAL_AXIS] != _loc2_.horizontalAxis)
               {
            ...
            if(!this._verticalAxis)
            {
               if(dataTransform.axes[CartesianTransform.VERTICAL_AXIS] != _loc2_.verticalAxis)
               {
      ...
      override public function claimStyles(param1:Array, param2:uint) : uint
      {
         ...
         var _loc3_:int = int(this._series.length);
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
      ...
      override mx_internal function clearSeriesItemsState(param1:Boolean, param2:String = "none") : void
      {
         ...
         var _loc4_:int = 0;
         super.mx_internal::clearSeriesItemsState(param1,param2);
         _loc4_ = 0;
         while(_loc4_ < this.series.length)
         {
            _loc3_ = this.series[_loc4_];
            _loc3_.mx_internal::clearSeriesItemsState(param1,param2);
            _loc4_++;
         }
      }
      ...
      public function stack() : void
      {
         ...
         var _loc4_:Object = null;
         var _loc7_:Array = null;
         var _loc1_:int = int(this._series.length);
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            if(this._type == "stacked" && this._allowNegativeForStacked)
            {
               ...
               this.stackedMinimum = isNaN(this.stackedMinimum) ? Number(_loc4_.minValue) : Math.min(this.stackedMinimum,_loc4_.minValue);
            }
            else
            {
               ...
               else
               {
                  ...
                  if(_loc7_.length)
                  {
                     this.stackedMinimum = isNaN(this.stackedMinimum) ? Number(_loc7_[0].min) : Math.min(this.stackedMinimum,_loc7_[0].min);
                  }
               }
            }
            _loc5_ = _loc3_;
