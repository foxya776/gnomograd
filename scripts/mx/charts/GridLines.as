package mx.charts
{
   ...
   public class GridLines extends ChartElement
   {
      ...
      private function initStyles() : Boolean
      {
         ...
         gridlinesStyleName = HaloDefaults.createSelector("mx.charts.GridLines",styleManager);
         ...
         hgridlinesStyle = HaloDefaults.createSelector(".horizontalGridLines",styleManager);
         ...
         bothGridLines = HaloDefaults.createSelector(".bothGridLines",styleManager);
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         if(_loc17_ == "horizontal" || _loc17_ == "both")
         {
            ...
            if(!CartesianChart(chart).mx_internal::verticalAxisRenderer)
            {
               _loc20_ = CartesianChart(chart).mx_internal::getLeftMostRenderer();
               if(!_loc20_)
               {
                  _loc20_ = CartesianChart(chart).mx_internal::getRightMostRenderer();
               }
            }
            else
            {
               _loc20_ = CartesianChart(chart).mx_internal::verticalAxisRenderer;
            }
            ...
            while(_loc21_ < _loc15_)
            {
               ...
               if(Boolean(_loc5_) && _loc11_.bottom >= -1)
               {
         ...
         if(_loc17_ == "vertical" || _loc17_ == "both")
         {
            ...
            if(!CartesianChart(chart).mx_internal::horizontalAxisRenderer)
            {
               _loc25_ = CartesianChart(chart).mx_internal::getBottomMostRenderer();
               if(!_loc25_)
               {
                  _loc25_ = CartesianChart(chart).mx_internal::getTopMostRenderer();
               }
            }
            else
            {
               _loc25_ = CartesianChart(chart).mx_internal::horizontalAxisRenderer;
            }
         ...
         if((Boolean(_loc19_)) || Boolean(_loc18_))
         {
            _loc28_ = [{
               "xOrigin":0,
               "yOrigin":0
            ...
            if(Boolean(_loc18_) && Boolean(_loc28_[0].y > 0) && _loc28_[0].y < param2)
            {
               _loc12_ = getStyle("horizontalOriginStroke");
               _loc12_.apply(_loc16_,null,null);
               _loc16_.moveTo(0,_loc28_[0].y - _loc29_ / 2);
               _loc16_.lineTo(mx_internal::$width,_loc28_[0].y - _loc29_ / 2);
            }
            if(Boolean(_loc19_) && Boolean(_loc28_[0].x > 0) && _loc28_[0].x < param1)
            {
               _loc12_ = getStyle("verticalOriginStroke");
               _loc12_.apply(_loc16_,null,null);
               _loc16_.moveTo(_loc28_[0].x - _loc29_ / 2,0);
               _loc16_.lineTo(_loc28_[0].x - _loc29_ / 2,mx_internal::$height);
            }
         }
      }
