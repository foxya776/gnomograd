package mx.charts
{
   ...
   public class LineChart extends CartesianChart
   {
      ...
      private function initStyles() : Boolean
      {
         ...
         lineChartStyle = HaloDefaults.createSelector("mx.charts.LineChart",styleManager);
         ...
         n = int(HaloDefaults.mx_internal::defaultColors.length);
         i = 0;
         while(i < n)
         {
            ...
            f(o,new Stroke(HaloDefaults.mx_internal::defaultColors[i],3,1));
            i++;
         }
         return true;
      }
