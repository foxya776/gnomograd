package mx.charts
{
   ...
   public class DateTimeAxis extends NumericAxis
   {
      ...
      private var _unitSize:Number = 86400000;
      ...
      {
         var _loc1_:uint = uint(DataDescription.REQUIRED_MIN_MAX | DataDescription.REQUIRED_BOUNDED_VALUES);
         if(this._userDataUnits == null)
         {
            _loc1_ |= DataDescription.REQUIRED_MIN_INTERVAL;
         }
         return _loc1_;
      }
      ...
      override public function transformCache(param1:Array, param2:String, param3:String) : void
      {
         ...
         update();
         var _loc4_:Number = computedMaximum - computedMinimum - this.dateRangeUtilities.mx_internal::calculateDisabledRange(computedMinimum,computedMaximum);
         var _loc5_:int = int(param1.length);
         if(Boolean(this.disabledRanges) || Boolean(this.disabledDays))
         {
            _loc7_ = 0;
            _loc6_ = 0;
            while(_loc6_ < _loc5_)
            {
               _loc7_ = this.dateRangeUtilities.mx_internal::calculateDisabledRange(computedMinimum,param1[_loc6_][param2]);
      ...
      override protected function adjustMinMax(param1:Number, param2:Number) : void
      {
         ...
         var _loc10_:Number = isNaN(this._interval) ? 1 : this._interval;
         if(this._userDataUnits == null)
         {
            _loc11_ = "years";
            ...
            {
               _loc3_ = Number(_loc19_[_loc12_].minInterval);
               if(!isNaN(_loc3_))
               {
         ...
         else
         {
            ...
            this._dataInterval = isNaN(this._userDataInterval) ? 1 : this._userDataInterval;
         }
         _loc11_ = "years";
         if(this._userLabelUnits != null && this._userLabelUnits != "")
         {
         ...
         {
            this._minorTickInterval = isNaN(this._userMinorTickInterval) ? 1 : this._userMinorTickInterval;
      ...
      override public function filterCache(param1:Array, param2:String, param3:String) : void
      {
         ...
         if(Boolean(this.disabledRanges) || Boolean(this.disabledDays))
         {
            ...
            while(_loc4_ < _loc5_)
            {
               param1[_loc4_][param3] = this.dateRangeUtilities.mx_internal::isDisabled(param1[_loc4_][param2]) ? NaN : param1[_loc4_][param2];
               _loc4_++;
            }
         }
      }
      ...
      override protected function buildLabelCache() : Boolean
      {
         ...
         this.dateRangeUtilities.mx_internal::createDisabledRangeSet(this.disabledDays,this.disabledRanges,computedMinimum,computedMaximum);
         ...
         var _loc7_:Number = labelMaximum + 0.000001;
         ...
         {
            case "months":
               _loc14_ = Number(_loc9_[this.monthP]);
               while(_loc9_.getTime() <= _loc7_)
               {
                  _loc10_ = _loc9_.getTime();
                  if(Boolean(this.disabledDays) || Boolean(this.disabledRanges))
                  {
                     if(_loc8_ != null)
                     {
                        _loc11_ = this.dateRangeUtilities.mx_internal::getDisabledRange(_loc8_.getTime() + 1,_loc10_,this._labelUnits);
                     }
                     else
                     {
                        _loc11_ = this.dateRangeUtilities.mx_internal::getDisabledRange(computedMinimum,_loc10_,this._labelUnits);
                     }
                     if(!this.dateRangeUtilities.mx_internal::isDisabled(_loc10_))
                     {
                        if(direction == "inverted")
                        {
               ...
               break;
            case "years":
               _loc15_ = Number(_loc9_[this.fullYearP]);
               while(_loc9_.getTime() <= _loc7_)
               {
                  _loc10_ = _loc9_.getTime();
                  if(Boolean(this.disabledDays) || Boolean(this.disabledRanges))
            ...
            default:
               ...
               while(_loc16_ <= _loc7_)
               {
                  ...
                  if(Boolean(this.disabledDays) || Boolean(this.disabledRanges))
                  {
                     if(_loc8_ != null)
                     {
                        _loc11_ = this.dateRangeUtilities.mx_internal::getDisabledRange(_loc8_.getTime() + 1,_loc16_,this._labelUnits);
                     }
                     else
                     {
                        _loc11_ = this.dateRangeUtilities.mx_internal::getDisabledRange(computedMinimum,_loc16_,this._labelUnits);
                     }
                     if(!this.dateRangeUtilities.mx_internal::isDisabled(_loc16_))
                     {
                        if(direction == "inverted")
                        {
                     ...
                     else
                     {
                        ...
                        {
                           _loc17_.dateUTC += 7 * computedInterval;
                           _loc16_ = _loc17_.time;
                        }
                        else if(this._labelUnits == "hours")
                        {
                           _loc17_.hoursUTC += computedInterval;
                           _loc16_ = _loc17_.time;
                        }
                        else if(this._labelUnits == "minutes")
                        {
                           _loc17_.minutesUTC += computedInterval;
                           _loc16_ = _loc17_.time;
                        }
                        else if(this._labelUnits == "seconds")
                        {
                           _loc17_.secondsUTC += computedInterval;
                           _loc16_ = _loc17_.time;
                        }
                        else if(this._labelUnits == "milliseconds")
                        {
                           _loc17_.millisecondsUTC += computedInterval;
                           _loc16_ = _loc17_.time;
                        }
                        else
                        {
                           _loc17_.dateUTC += computedInterval;
                           _loc16_ = _loc17_.time;
                        }
                     }
                  }
      ...
      override public function reduceLabels(param1:AxisLabel, param2:AxisLabel) : AxisLabelSet
      {
         ...
         var _loc5_:Array = [];
         var _loc6_:Array = [];
         var _loc8_:int = int(labelCache.length);
         _loc7_ = 0;
         while(_loc7_ < _loc8_)
         {
         ...
         _loc8_ = int(minorTickCache.length);
         _loc7_ = 0;
         while(_loc7_ < _loc8_)
         {
      ...
      override protected function buildMinorTickCache() : Array
      {
         ...
         var _loc3_:Number = computedMaximum - computedMinimum - this.dateRangeUtilities.mx_internal::calculateDisabledRange(computedMinimum,computedMaximum);
         var _loc4_:Number = this.toMilli(this._minorTickInterval,this._minorTickUnits);
         var _loc5_:Number = labelMinimum;
         var _loc6_:Number = labelMaximum + 0.000001;
         ...
         {
            case "months":
               _loc14_ = Number(_loc8_[this.monthP]);
               while(_loc8_.getTime() <= _loc6_)
               {
                  ...
                  if(Boolean(this.disabledDays) || Boolean(this.disabledRanges))
                  {
                     if(_loc7_ != null)
                     {
                        _loc12_ = this.dateRangeUtilities.mx_internal::getDisabledRange(_loc7_.getTime() + 1,_loc9_,this._minorTickUnits);
                     }
                     else
                     {
                        _loc12_ = this.dateRangeUtilities.mx_internal::getDisabledRange(computedMinimum,_loc9_,this._minorTickUnits);
                     }
                     if(!this.dateRangeUtilities.mx_internal::isDisabled(_loc9_))
                     {
                  ...
                  _loc14_ += this._minorTickInterval;
               ...
               break;
            case "years":
               _loc15_ = Number(_loc8_[this.fullYearP]);
               while(_loc8_.getTime() <= _loc6_)
               {
                  _loc9_ = _loc8_.getTime();
                  if(Boolean(this.disabledDays) || Boolean(this.disabledRanges))
                  ...
                  _loc15_ += this._minorTickInterval;
                  _loc8_.setTime(_loc5_);
            ...
            default:
               ...
               while(_loc16_ <= _loc6_)
               {
                  ...
                  if(Boolean(this.disabledDays) || Boolean(this.disabledRanges))
                  {
                     if(_loc7_ != null)
                     {
                        _loc12_ = this.dateRangeUtilities.mx_internal::getDisabledRange(_loc7_.getTime() + 1,_loc16_,this._minorTickUnits);
                     }
                     else
                     {
                        _loc12_ = this.dateRangeUtilities.mx_internal::getDisabledRange(computedMinimum,_loc16_,this._minorTickUnits);
                     }
                     if(!this.dateRangeUtilities.mx_internal::isDisabled(_loc16_))
                     {
                  ...
                  {
                     _loc17_.dateUTC += 7 * this._minorTickInterval;
                     _loc16_ = _loc17_.time;
                  }
                  else if(this._minorTickUnits == "hours")
                  {
                     _loc17_.hoursUTC += this._minorTickInterval;
                     _loc16_ = _loc17_.time;
                  }
                  else if(this._minorTickUnits == "minutes")
                  {
                     _loc17_.minutesUTC += this._minorTickInterval;
                     _loc16_ = _loc17_.time;
                  }
                  else if(this._minorTickUnits == "seconds")
                  {
                     _loc17_.secondsUTC += this._minorTickInterval;
                     _loc16_ = _loc17_.time;
                  }
                  else if(this._minorTickUnits == "milliseconds")
                  {
                     _loc17_.millisecondsUTC += this._minorTickInterval;
                     _loc16_ = _loc17_.time;
                  }
                  else
                  {
                     _loc17_.dateUTC += this._minorTickInterval;
                     _loc16_ = _loc17_.time;
                  }
               }
         }
      ...
      private function roundDateUp(param1:Date, param2:String) : void
      {
         switch(param2)
         {
            ...
            case "weeks":
               ...
               {
                  param1[this.dateP] += 7 - param1[this.dayP];
               }
               break;
            case "months":
      ...
      private function roundDateDown(param1:Date, param2:String) : void
      {
         switch(param2)
         {
            ...
            case "weeks":
               ...
               if(param1[this.dayP] != 0)
               {
                  param1[this.dateP] -= param1[this.dayP];
               }
               break;
            case "months":
               param1[this.hoursP] = 0;
      ...
      {
         var _loc4_:Number = Number(param1[this.fullYearP]);
