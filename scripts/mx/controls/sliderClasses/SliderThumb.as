package mx.controls.sliderClasses
{
   ...
   public class SliderThumb extends Button
   {
      ...
      override protected function keyDownHandler(param1:KeyboardEvent) : void
      {
         ...
         var _loc2_:Boolean = Slider(owner).thumbCount > 1;
         ...
         var _loc5_:Boolean = Slider(owner).direction == SliderDirection.HORIZONTAL;
         var _loc7_:uint = mx_internal::mapKeycodeForLayoutDirection(param1);
