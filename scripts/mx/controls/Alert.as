   ...
   public class Alert extends Panel
   {
      ...
      public static function show(param1:String = "", param2:String = "", param3:uint = 4, param4:Sprite = null, param5:Function = null, param6:Class = null, param7:uint = 4, param8:IFlexModuleFactory = null) : Alert
      {
         ...
         if(!param4)
         {
            ...
            _loc12_ = _loc11_.getImplementation("mx.managers.IMarshallPlanSystemManager");
            if((Boolean(_loc12_)) && Boolean(_loc12_.useSWFBridge()))
            {
      ...
      override protected function createChildren() : void
      {
         ...
         if(!this.mx_internal::alertForm)
         {
            this.mx_internal::alertForm = new AlertForm();
            this.mx_internal::alertForm.styleName = this;
            addChild(this.mx_internal::alertForm);
         }
      }
      ...
      override protected function measure() : void
      {
         ...
         super.measure();
         _loc1_ = viewMetrics;
         measuredWidth = Math.max(measuredWidth,this.mx_internal::alertForm.getExplicitOrMeasuredWidth() + _loc1_.left + _loc1_.right);
         measuredHeight = this.mx_internal::alertForm.getExplicitOrMeasuredHeight() + _loc1_.top + _loc1_.bottom;
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         this.mx_internal::alertForm.setActualSize(param1 - _loc3_.left - _loc3_.right - getStyle("paddingLeft") - getStyle("paddingRight"),param2 - _loc3_.top - _loc3_.bottom - getStyle("paddingTop") - getStyle("paddingBottom"));
      }
      ...
      override public function styleChanged(param1:String) : void
      {
         ...
         if(this.mx_internal::alertForm)
         {
            this.mx_internal::alertForm.styleChanged(param1);
         }
      }
