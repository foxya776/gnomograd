   ...
   public class Button extends UIComponent implements IDataRenderer, IDropInListItemRenderer, IFocusManagerComponent, IListItemRenderer, IFontContextComponent, IButton
   {
      ...
      override protected function measure() : void
      {
         ...
         if(this.label)
         {
            ...
            _loc1_ = _loc9_.width + mx_internal::TEXT_WIDTH_PADDING;
         ...
         var _loc8_:EdgeMetrics = Boolean(this.mx_internal::currentSkin) && Boolean(this.mx_internal::currentSkin is IBorder) && !(this.mx_internal::currentSkin is IFlexAsset) ? IBorder(this.mx_internal::currentSkin).borderMetrics : null;
         if(_loc8_)
         {
      ...
      mx_internal function layoutContents(param1:Number, param2:Number, param3:Boolean) : void
      {
         ...
         if(this.label)
         {
            ...
            _loc18_ = _loc20_.width + mx_internal::TEXT_WIDTH_PADDING;
         ...
         var _loc25_:EdgeMetrics = Boolean(this.mx_internal::currentSkin) && Boolean(this.mx_internal::currentSkin is IBorder) && !(this.mx_internal::currentSkin is IFlexAsset) ? IBorder(this.mx_internal::currentSkin).borderMetrics : null;
         if(_loc25_)
         {
         ...
         {
            _loc8_ = this.mx_internal::currentIcon.width;
            _loc9_ = this.mx_internal::currentIcon.height;
         }
         if(this.labelPlacement == ButtonLabelPlacement.LEFT || this.labelPlacement == ButtonLabelPlacement.RIGHT)
         {
         ...
         if(this.mx_internal::currentIcon)
         {
            ...
            _loc28_.oldX = this.mx_internal::currentIcon.x;
