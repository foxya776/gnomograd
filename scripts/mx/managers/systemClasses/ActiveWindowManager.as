package mx.managers.systemClasses
{
   ...
   public class ActiveWindowManager extends EventDispatcher implements IActiveWindowManager
   {
      ...
      private function activateForm(param1:Object) : void
      {
         ...
         if(this.mx_internal::form)
         {
            if(this.mx_internal::form != param1 && this.mx_internal::forms.length > 1)
            {
               ...
               {
                  _loc4_ = IFocusManagerContainer(this.mx_internal::form);
      ...
      {
         var _loc2_:int = int(this.mx_internal::forms.length);
         var _loc3_:* = int(this.mx_internal::forms.length - 1);
         while(_loc3_ >= 0)
         {
            if(this.mx_internal::forms[_loc3_] != param1 && this.canActivatePopUp(this.mx_internal::forms[_loc3_]))
            {
      ...
      private function mouseDownHandler(param1:MouseEvent) : void
      {
         ...
         if(this.numModalWindows == 0)
         {
            ...
            {
               _loc2_ = int(this.mx_internal::forms.length);
               _loc3_ = DisplayObject(param1.target);
               _loc4_ = this.systemManager.document is IRawChildrenContainer ? IRawChildrenContainer(this.systemManager.document).rawChildren.contains(_loc3_) : Boolean(this.systemManager.document.contains(_loc3_));
               while(_loc3_)
               {
                  _loc5_ = 0;
                  while(_loc5_ < _loc2_)
                  {
                     ...
                     if(hasEventListener("actualForm"))
                     {
                        ...
                        _loc7_.value = this.mx_internal::forms[_loc5_];
                     ...
                     if(_loc6_ == _loc3_)
                     {
                        ...
                        for(; _loc8_ < _loc2_; _loc8_++)
                        {
                           ...
                           if(hasEventListener("isRemote"))
                           {
                              ...
                              _loc7_.value = this.mx_internal::forms[_loc8_];
                              _loc13_ = false;
                              if(!dispatchEvent(_loc7_))
                              {
