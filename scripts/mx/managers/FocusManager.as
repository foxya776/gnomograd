package mx.managers
{
   ...
   public class FocusManager extends EventDispatcher implements IFocusManager
   {
      ...
      {
         var _loc2_:Boolean = this.mx_internal::_showFocusIndicator != param1;
      ...
      private function getMaxTabIndex() : int
      {
         ...
         var _loc1_:Number = 0;
         var _loc2_:int = int(this.mx_internal::focusableObjects.length);
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
      ...
      private function sortFocusableObjectsTabIndex() : void
      {
         ...
         var _loc1_:int = int(this.mx_internal::focusableObjects.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.mx_internal::focusableObjects[_loc2_] as IFocusManagerComponent;
            if(Boolean(_loc3_ && _loc3_.tabIndex) && Boolean(!isNaN(Number(_loc3_.tabIndex))) || this.mx_internal::focusableObjects[_loc2_] is ISWFLoader)
            {
      ...
      private function removedHandler(param1:Event) : void
      {
         ...
         if((Boolean(_loc4_)) && _loc3_ != this.focusPane)
         {
      ...
      {
         var _loc2_:DisplayObject = DisplayObject(param1.target);
         if(Boolean(this.mx_internal::lastFocus) && Boolean(!this.isEnabledAndVisible(DisplayObject(this.mx_internal::lastFocus))) && Boolean(DisplayObject(this.mx_internal::form).stage))
         {
      ...
      private function viewHideHandler(param1:Event) : void
      {
         ...
         if(Boolean(_loc2_) && Boolean(_loc3_) && _loc2_.contains(_loc3_))
         {
            this.mx_internal::lastFocus = null;
         }
      }
      ...
      private function creationCompleteHandler(param1:FlexEvent) : void
      {
         ...
         if(Boolean(_loc2_.parent) && Boolean(_loc2_.visible) && !this.activated)
         {
      ...
      private function tabFocusEnabledChangeHandler(param1:Event) : void
      {
         ...
         var _loc3_:int = int(this.mx_internal::focusableObjects.length);
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
      ...
      mx_internal function keyFocusChangeHandler(param1:FocusEvent) : void
      {
         ...
         this.showFocusIndicator = true;
         this.mx_internal::focusChanged = false;
         var _loc3_:Boolean = this.browserFocusComponent != null;
         if(this.browserFocusComponent)
         {
