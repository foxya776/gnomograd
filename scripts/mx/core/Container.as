package mx.core
{
   ...
   public class Container extends UIComponent implements IContainer, IDataRenderer, IFocusManagerContainer, IListItemRenderer, IRawChildrenContainer, IChildList, IVisualElementContainer, INavigatorContent
   {
      ...
      override public function set doubleClickEnabled(param1:Boolean) : void
      {
         ...
         if(this.mx_internal::contentPane)
         {
            _loc2_ = this.mx_internal::contentPane.numChildren;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.mx_internal::contentPane.getChildAt(_loc3_) as InteractiveObject;
               if(_loc4_)
               {
      ...
      override public function set focusPane(param1:Sprite) : void
      {
         ...
         if(Boolean(param1) && Boolean(this.mx_internal::contentPane))
         {
            param1.x = this.mx_internal::contentPane.x;
            param1.y = this.mx_internal::contentPane.y;
            param1.scrollRect = this.mx_internal::contentPane.scrollRect;
         }
      ...
      {
         return Boolean(this.mx_internal::border) && this.mx_internal::border is IRectangularBorder ? IRectangularBorder(this.mx_internal::border).borderMetrics : EdgeMetrics.EMPTY;
      }
      ...
      public function set creationPolicy(param1:String) : void
      {
         ...
         this.mx_internal::setActualCreationPolicies(param1);
      }
      ...
      {
         if(this.mx_internal::_horizontalScrollPolicy != param1)
         {
            this.mx_internal::_horizontalScrollPolicy = param1;
            invalidateDisplayList();
      ...
      {
         return this.mx_internal::childRepeaters ? int(this.mx_internal::childRepeaters.length) : 0;
      }
      ...
      {
         if(this.mx_internal::_verticalScrollPolicy != param1)
         {
            this.mx_internal::_verticalScrollPolicy = param1;
            invalidateDisplayList();
      ...
      public function get viewMetrics() : EdgeMetrics
      {
         ...
         var _loc2_:Boolean = this.verticalScrollBar != null && (this.mx_internal::doingLayout || this.verticalScrollPolicy == ScrollPolicy.ON);
         var _loc3_:Boolean = this.horizontalScrollBar != null && (this.mx_internal::doingLayout || this.horizontalScrollPolicy == ScrollPolicy.ON);
         if(!_loc2_ && !_loc3_)
         {
            return _loc1_;
         }
      ...
      override public function addChildAt(param1:DisplayObject, param2:int) : DisplayObject
      {
         ...
         if(this.mx_internal::contentPane)
         {
            this.mx_internal::contentPane.addChildAt(param1,param2);
         }
         else
         {
            mx_internal::$addChildAt(param1,this._firstChildIndex + param2);
         }
      ...
      override public function removeChild(param1:DisplayObject) : DisplayObject
      {
         ...
         if(param1 is IDeferredInstantiationUIComponent && Boolean(IDeferredInstantiationUIComponent(param1).descriptor))
         {
            ...
            {
               _loc2_ = int(this.mx_internal::createdComponents.length);
               _loc3_ = 0;
               while(_loc3_ < _loc2_)
               {
                  if(this.mx_internal::createdComponents[_loc3_] === param1)
                  {
                     this.mx_internal::createdComponents.splice(_loc3_,1);
                  }
                  _loc3_++;
               }
            }
         ...
         if(this.mx_internal::contentPane)
         {
            this.mx_internal::contentPane.removeChild(param1);
         }
         else
         {
      ...
      override public function getChildAt(param1:int) : DisplayObject
      {
         if(this.mx_internal::contentPane)
         {
            return this.mx_internal::contentPane.getChildAt(param1);
         }
      ...
      override public function getChildByName(param1:String) : DisplayObject
      {
         ...
         if(this.mx_internal::contentPane)
         {
            return this.mx_internal::contentPane.getChildByName(param1);
         }
         ...
         if(_loc3_ < 0 || _loc3_ >= this.mx_internal::_numChildren)
         {
            return null;
         }
         return _loc2_;
      ...
      override public function getChildIndex(param1:DisplayObject) : int
      {
         ...
         if(this.mx_internal::contentPane)
         {
            return this.mx_internal::contentPane.getChildIndex(param1);
         }
      ...
      override public function setChildIndex(param1:DisplayObject, param2:int) : void
      {
         ...
         if(this.mx_internal::contentPane)
         {
            this.mx_internal::contentPane.setChildIndex(param1,param2);
      ...
      override public function contains(param1:DisplayObject) : Boolean
      {
         if(this.mx_internal::contentPane)
         {
            return this.mx_internal::contentPane.contains(param1);
         }
      ...
      override public function initialize() : void
      {
         ...
         if(Boolean(mx_internal::documentDescriptor) && !processedDescriptors)
         {
      ...
      override protected function createChildren() : void
      {
         ...
         UIComponentGlobals.mx_internal::layoutManager.addEventListener(FlexEvent.UPDATE_COMPLETE,this.layoutCompleteHandler,false,0,true);
      }
      ...
      override public function validateDisplayList() : void
      {
         ...
         if(this.mx_internal::contentPane)
         {
            ...
            this.mx_internal::contentPane.x = _loc1_.left;
            this.mx_internal::contentPane.y = _loc1_.top;
            if(this.focusPane)
            {
         ...
         if(this.mx_internal::blocker)
         {
            ...
            this.mx_internal::blocker.x = _loc1_.left;
            this.mx_internal::blocker.y = _loc1_.top;
            ...
            this.mx_internal::blocker.graphics.beginFill(uint(_loc4_),_loc5_);
            this.mx_internal::blocker.graphics.drawRect(0,0,_loc6_,_loc7_);
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         if(Boolean(this.mx_internal::contentPane) && Boolean(this.mx_internal::contentPane.scrollRect))
         {
            ...
            if(!this._clipContent || isNaN(Number(_loc3_)) || _loc3_ === "" || !(Boolean(this.horizontalScrollBar) || Boolean(this.verticalScrollBar)) && !cacheAsBitmap)
            {
               _loc3_ = null;
            }
            ...
            this.mx_internal::contentPane.opaqueBackground = _loc3_;
            this.mx_internal::contentPane.cacheAsBitmap = _loc3_ != null;
         }
      }
      ...
      override public function contentToGlobal(param1:Point) : Point
      {
         if(this.mx_internal::contentPane)
         {
            return this.mx_internal::contentPane.localToGlobal(param1);
         }
      ...
      override public function globalToContent(param1:Point) : Point
      {
         if(this.mx_internal::contentPane)
         {
            return this.mx_internal::contentPane.globalToLocal(param1);
         }
      ...
      override public function styleChanged(param1:String) : void
      {
         ...
         if(_loc2_ || param1 == "borderSkin")
         {
            ...
            {
               this.rawChildren.removeChild(DisplayObject(this.mx_internal::border));
      ...
      override public function notifyStyleChangeInChildren(param1:String, param2:Boolean) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            if(Boolean(this.mx_internal::contentPane) || Boolean(_loc4_ < this._firstChildIndex) || _loc4_ >= this._firstChildIndex + this.mx_internal::_numChildren)
            {
      ...
      {
         var _loc2_:Rectangle = Boolean(this.mx_internal::contentPane) && Boolean(this.mx_internal::contentPane.scrollRect) ? this.mx_internal::contentPane.scrollRect : null;
         if(_loc2_)
         {
      ...
      override public function finishPrint(param1:Object, param2:IFlexDisplayObject) : void
      {
         if(param1)
         {
            this.mx_internal::contentPane.scrollRect = Rectangle(param1);
         }
      ...
      override mx_internal function addingChild(param1:DisplayObject) : void
      {
         ...
         if(!this.mx_internal::contentPane)
         {
            ...
            ++this.mx_internal::_numChildren;
         }
         if(Boolean(this.mx_internal::contentPane) && !this.autoLayout)
         {
            this.forceLayout = true;
            UIComponentGlobals.mx_internal::layoutManager.addEventListener(FlexEvent.UPDATE_COMPLETE,this.layoutCompleteHandler,false,0,true);
         }
      ...
      public function createComponentsFromDescriptors(param1:Boolean = true) : void
      {
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            this.mx_internal::createdComponents.push(_loc4_);
            _loc3_++;
         }
      ...
      public function createComponentFromDescriptor(param1:ComponentDescriptor, param2:Boolean) : IFlexDisplayObject
      {
         ...
         if((this.numChildrenBefore != 0 || this.mx_internal::numChildrenCreated != -1) && _loc3_.mx_internal::instanceIndices == null && this.hasChildMatchingDescriptor(_loc3_))
         {
            return null;
         }
         ...
         if(_loc6_ is IRepeater)
         {
            ...
            this.mx_internal::childRepeaters.push(_loc6_);
      ...
      private function hasChildMatchingDescriptor(param1:UIComponentDescriptor) : Boolean
      {
         ...
         if(this.mx_internal::childRepeaters)
         {
            _loc3_ = int(this.mx_internal::childRepeaters.length);
            _loc4_ = 0;
            while(_loc4_ < _loc3_)
            {
               if(IDeferredInstantiationUIComponent(this.mx_internal::childRepeaters[_loc4_]).descriptor == param1)
               {
                  return true;
               }
               _loc4_++;
      ...
      {
         if(this._firstChildIndex < param2 && param2 < this._firstChildIndex + this.mx_internal::_numChildren + 1)
         {
            ++this.mx_internal::_numChildren;
         }
      ...
      {
         var _loc2_:int = this.mx_internal::rawChildren_getChildIndex(param1);
         return this.mx_internal::rawChildren_removeChildAt(_loc2_);
      }
      ...
      mx_internal function rawChildren_removeChildAt(param1:int) : DisplayObject
      {
         ...
         if(this._firstChildIndex < param1 && param1 < this._firstChildIndex + this.mx_internal::_numChildren)
         {
            --this.mx_internal::_numChildren;
         }
         else if(this.mx_internal::_numChildren == 0 || param1 < this._firstChildIndex)
         {
            --this._firstChildIndex;
         }
         invalidateSize();
      ...
      protected function createBorder() : void
      {
         ...
         if(!this.mx_internal::border && this.isBorderNeeded())
         {
            ...
            if(_loc1_ != null)
            {
               ...
               if(this.mx_internal::border is IUIComponent)
               {
                  IUIComponent(this.mx_internal::border).enabled = enabled;
               }
               if(this.mx_internal::border is ISimpleStyleClient)
               {
                  ISimpleStyleClient(this.mx_internal::border).styleName = this;
               }
               this.rawChildren.addChildAt(DisplayObject(this.mx_internal::border),0);
               invalidateDisplayList();
            }
         }
      }
      ...
      private function createOrDestroyBlocker() : void
      {
         ...
         {
            this.mx_internal::blocker = new FlexSprite();
            ...
            this.mx_internal::blocker.addEventListener(MouseEvent.CLICK,this.blocker_clickHandler);
      ...
      {
         var _loc1_:IRectangularBorder = this.mx_internal::border as IRectangularBorder;
         if(!_loc1_)
         {
            return;
         }
      ...
      private function createContentPaneAndScrollbarsIfNeeded() : Boolean
      {
         ...
         {
            _loc1_ = this.mx_internal::getScrollableRect();
         ...
         if(_loc2_ && Boolean(this.mx_internal::border))
         {
            this.updateBackgroundImageRect();
         }
         return _loc2_;
      ...
      mx_internal function createContentPane() : void
      {
         ...
         if(this.mx_internal::border)
         {
            _loc3_ = this.rawChildren.getChildIndex(DisplayObject(this.mx_internal::border)) + 1;
            if(this.mx_internal::border is IRectangularBorder && IRectangularBorder(this.mx_internal::border).hasBackgroundImage)
            {
               _loc3_++;
            }
         }
         ...
         this.mx_internal::contentPane = _loc2_;
      ...
      protected function scrollChildren() : void
      {
         ...
         var _loc6_:Rectangle = this.mx_internal::getScrollableRect();
         ...
         {
            this.mx_internal::contentPane.scrollRect = new Rectangle(_loc2_,_loc3_,_loc4_,_loc5_);
         }
         if(this.focusPane)
         {
            this.focusPane.scrollRect = this.mx_internal::contentPane.scrollRect;
         }
         if(Boolean(this.mx_internal::border) && Boolean(this.mx_internal::border is IRectangularBorder) && IRectangularBorder(this.mx_internal::border).hasBackgroundImage)
         {
            IRectangularBorder(this.mx_internal::border).layoutBackgroundImage();
         }
      }
      ...
      override protected function keyDownHandler(param1:KeyboardEvent) : void
      {
         ...
         if(this.horizontalScrollBar)
         {
            ...
            _loc5_ = mx_internal::mapKeycodeForLayoutDirection(param1);
            switch(_loc5_)
            {
               case Keyboard.LEFT:
      ...
      {
         UIComponentGlobals.mx_internal::layoutManager.removeEventListener(FlexEvent.UPDATE_COMPLETE,this.layoutCompleteHandler);
      ...
      {
         --this.mx_internal::numChildrenCreated;
