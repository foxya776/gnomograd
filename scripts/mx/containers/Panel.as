package mx.containers
{
   ...
   public class Panel extends Container implements IConstraintLayout, IFontContextComponent
   {
      ...
      override public function set enabled(param1:Boolean) : void
      {
         ...
         if(this.mx_internal::closeButton)
         {
            this.mx_internal::closeButton.enabled = param1;
         }
      }
      ...
      {
         if(Boolean(this.controlBar) && param1 == this.controlBar)
         {
            return numChildren;
         }
      ...
      override protected function createChildren() : void
      {
         ...
         if(!this.mx_internal::titleBarBackground)
         {
            _loc1_ = getStyle("titleBackgroundSkin");
            if(_loc1_)
            {
               this.mx_internal::titleBarBackground = new _loc1_();
               _loc2_ = this.mx_internal::titleBarBackground as IStyleClient;
               if(_loc2_)
               {
                  _loc2_.setStyle("backgroundImage",undefined);
               }
               _loc3_ = this.mx_internal::titleBarBackground as ISimpleStyleClient;
               if(_loc3_)
               {
                  _loc3_.styleName = this;
               }
               this.titleBar.addChild(DisplayObject(this.mx_internal::titleBarBackground));
            }
         }
         this.mx_internal::createTitleTextField(-1);
         this.mx_internal::createStatusTextField(-1);
         if(!this.mx_internal::closeButton)
         {
            this.mx_internal::closeButton = new Button();
            this.mx_internal::closeButton.styleName = new StyleProxy(this,this.closeButtonStyleFilters);
            this.mx_internal::closeButton.mx_internal::upSkinName = "closeButtonUpSkin";
            this.mx_internal::closeButton.mx_internal::overSkinName = "closeButtonOverSkin";
            this.mx_internal::closeButton.mx_internal::downSkinName = "closeButtonDownSkin";
            this.mx_internal::closeButton.mx_internal::disabledSkinName = "closeButtonDisabledSkin";
            this.mx_internal::closeButton.mx_internal::skinName = "closeButtonSkin";
            this.mx_internal::closeButton.explicitWidth = this.mx_internal::closeButton.explicitHeight = 16;
            this.mx_internal::closeButton.focusEnabled = false;
            this.mx_internal::closeButton.visible = false;
            this.mx_internal::closeButton.enabled = enabled;
            this.mx_internal::closeButton.addEventListener(MouseEvent.CLICK,this.closeButton_clickHandler);
            this.titleBar.addChild(this.mx_internal::closeButton);
            this.mx_internal::closeButton.owner = this;
         }
      }
      ...
      override protected function commitProperties() : void
      {
         ...
         if(hasFontContextChanged())
         {
            if(this.titleTextField)
            {
               ...
               this.mx_internal::removeTitleTextField();
               this.mx_internal::createTitleTextField(_loc1_);
               this._titleChanged = true;
            }
            if(this.statusTextField)
            {
               _loc1_ = this.titleBar.getChildIndex(DisplayObject(this.statusTextField));
               this.mx_internal::removeStatusTextField();
               this.mx_internal::createStatusTextField(_loc1_);
               this._statusChanged = true;
            }
         }
         ...
         if(this._titleIconChanged)
         {
            ...
            if(this.mx_internal::titleIconObject)
            {
               this.titleBar.removeChild(DisplayObject(this.mx_internal::titleIconObject));
               this.mx_internal::titleIconObject = null;
            }
            if(this._titleIcon)
            {
               this.mx_internal::titleIconObject = new this._titleIcon();
               this.titleBar.addChild(DisplayObject(this.mx_internal::titleIconObject));
            }
            if(initialized)
            {
               this.layoutChrome(unscaledWidth,unscaledHeight);
      ...
      override protected function measure() : void
      {
         ...
         if(this.mx_internal::titleIconObject)
         {
            _loc2_ += this.mx_internal::titleIconObject.width;
         }
         if(this.mx_internal::closeButton)
         {
            _loc2_ += this.mx_internal::closeButton.getExplicitOrMeasuredWidth() + 6;
         }
         ...
         if(_loc2_ || param1 == "titleBackgroundSkin")
         {
            if(this.titleBar)
            {
               ...
               if(_loc6_)
               {
                  if(this.mx_internal::titleBarBackground)
                  {
                     this.titleBar.removeChild(DisplayObject(this.mx_internal::titleBarBackground));
                     this.mx_internal::titleBarBackground = null;
                  }
                  this.mx_internal::titleBarBackground = new _loc6_();
                  _loc7_ = this.mx_internal::titleBarBackground as IStyleClient;
                  if(_loc7_)
                  {
                     _loc7_.setStyle("backgroundImage",undefined);
                  }
                  _loc8_ = this.mx_internal::titleBarBackground as ISimpleStyleClient;
                  if(_loc8_)
                  {
                     _loc8_.styleName = this;
                  }
                  this.titleBar.addChildAt(DisplayObject(this.mx_internal::titleBarBackground),0);
               }
            }
         }
      }
      ...
      override protected function layoutChrome(param1:Number, param2:Number) : void
      {
         ...
         if(_loc8_ > 0 && height >= _loc8_)
         {
            ...
            if(this.mx_internal::titleBarBackground)
            {
               this.mx_internal::titleBarBackground.move(0,0);
               IFlexDisplayObject(this.mx_internal::titleBarBackground).setActualSize(_loc9_,_loc8_);
            }
            this.mx_internal::closeButton.visible = this.mx_internal::_showCloseButton;
            if(this.mx_internal::_showCloseButton)
            {
               this.mx_internal::closeButton.setActualSize(this.mx_internal::closeButton.getExplicitOrMeasuredWidth(),this.mx_internal::closeButton.getExplicitOrMeasuredHeight());
               this.mx_internal::closeButton.move(param1 - _loc6_ - _loc5_.right - 10 - this.mx_internal::closeButton.getExplicitOrMeasuredWidth(),(_loc8_ - this.mx_internal::closeButton.getExplicitOrMeasuredHeight()) / 2);
            }
            _loc11_ = 10;
            _loc12_ = 10;
            if(this.mx_internal::titleIconObject)
            {
               _loc13_ = Number(this.mx_internal::titleIconObject.height);
               _loc14_ = (_loc8_ - _loc13_) / 2;
               this.mx_internal::titleIconObject.move(_loc11_,_loc14_);
               _loc11_ += this.mx_internal::titleIconObject.width + 4;
            }
            ...
            this.titleTextField.setActualSize(Math.max(0,param1 - _loc11_ - _loc12_ - _loc15_),_loc13_ + UITextField.mx_internal::TEXT_HEIGHT_PADDING);
            _loc13_ = this.statusTextField.text != "" ? this.statusTextField.getUITextFormat().measureText(this.statusTextField.text).height : 0;
            _loc14_ = (_loc8_ - _loc13_) / 2;
            _loc16_ = param1 - _loc12_ - 4 - _loc15_ - this.statusTextField.textWidth;
            if(this.mx_internal::_showCloseButton)
            {
               _loc16_ -= this.mx_internal::closeButton.getExplicitOrMeasuredWidth() + 4;
            }
            this.statusTextField.move(_loc16_,_loc14_ - 1);
            this.statusTextField.setActualSize(this.statusTextField.textWidth + 8,this.statusTextField.textHeight + UITextField.mx_internal::TEXT_HEIGHT_PADDING);
         ...
         if(this.controlBar)
         {
            _loc18_ = Number(this.controlBar.x);
            _loc19_ = Number(this.controlBar.y);
            _loc20_ = Number(this.controlBar.width);
            _loc21_ = Number(this.controlBar.height);
      ...
      private function setControlBar(param1:IUIComponent) : void
      {
         ...
         if(Boolean(_loc2_) && this.controlBar is ISimpleStyleClient)
         {
      ...
      {
         if(param1.target == this.mx_internal::closeButton)
         {
            return;
         }
