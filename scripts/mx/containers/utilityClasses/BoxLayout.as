package mx.containers.utilityClasses
{
   ...
   public class BoxLayout extends Layout
   {
      ...
      override public function measure() : void
      {
         ...
         var _loc6_:Number = 0;
         var _loc7_:int;
         var _loc8_:* = _loc7_ = _loc1_.numChildren;
         var _loc9_:int = 0;
         while(_loc9_ < _loc7_)
         {
            _loc12_ = _loc1_.mx_internal::getLayoutChildAt(_loc9_);
            ...
            else
            {
               ...
               if(_loc2_)
               {
                  _loc3_ = Math.max(!isNaN(_loc12_.percentWidth) ? _loc12_.minWidth : _loc13_,_loc3_);
               ...
               else
               {
                  ...
                  _loc5_ += _loc13_;
                  _loc4_ = Math.max(!isNaN(_loc12_.percentHeight) ? _loc12_.minHeight : _loc14_,_loc4_);
                  _loc6_ = Math.max(_loc14_,_loc6_);
               }
            }
            _loc9_++;
         }
         _loc10_ = this.mx_internal::widthPadding(_loc8_);
         _loc11_ = this.mx_internal::heightPadding(_loc8_);
      ...
      override public function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         var _loc8_:Number = this.mx_internal::getHorizontalAlignValue();
         var _loc9_:Number = this.mx_internal::getVerticalAlignValue();
         ...
         if(_loc4_ == 1)
         {
            _loc23_ = _loc3_.mx_internal::getLayoutChildAt(0);
         ...
         else if(this.isVertical())
         {
            ...
            while(_loc21_ < _loc4_)
            {
               _loc22_ = _loc3_.mx_internal::getLayoutChildAt(_loc21_);
