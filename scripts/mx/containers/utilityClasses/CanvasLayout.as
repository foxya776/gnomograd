package mx.containers.utilityClasses
{
   ...
   public class CanvasLayout extends Layout
   {
      ...
      override public function measure() : void
      {
         ...
         {
            _loc7_ = _loc1_.mx_internal::getLayoutChildAt(_loc4_);
      ...
      override public function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         if(this.constraintRegionsInUse)
         {
            ...
            while(_loc3_ < _loc6_)
            {
               _loc4_ = _loc5_.mx_internal::getLayoutChildAt(_loc3_);
      ...
      private function measureContentArea() : Rectangle
      {
         ...
         while(_loc1_ < _loc2_)
         {
            _loc5_ = target.mx_internal::getLayoutChildAt(_loc1_);
            ...
            if(_loc5_.includeInLayout)
            {
               ...
               if(!isNaN(_loc5_.percentWidth) || Boolean(_loc6_ && !isNaN(_loc6_.left) && !isNaN(_loc6_.right)) && Boolean(isNaN(_loc5_.explicitWidth)))
               {
                  _loc9_ = _loc5_.minWidth;
               }
               if(!isNaN(_loc5_.percentHeight) || Boolean(_loc6_ && !isNaN(_loc6_.top) && !isNaN(_loc6_.bottom)) && Boolean(isNaN(_loc5_.explicitHeight)))
               {
