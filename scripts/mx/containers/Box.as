package mx.containers
{
   ...
   public class Box extends Container
   {
      ...
      {
         super();
         this.mx_internal::layoutObject.target = this;
      }
      
      [Bindable("directionChanged")]
      public function get direction() : String
      {
         return this.mx_internal::layoutObject.direction;
      }
      
      public function set direction(param1:String) : void
      {
         this.mx_internal::layoutObject.direction = param1;
         invalidateSize();
      ...
      {
         super.measure();
         this.mx_internal::layoutObject.measure();
      }
      
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         super.updateDisplayList(param1,param2);
         this.mx_internal::layoutObject.updateDisplayList(param1,param2);
      }
      ...
      public function pixelsToPercent(param1:Number) : Number
      {
         ...
         var _loc2_:Boolean = this.mx_internal::isVertical();
         var _loc3_:Number = 0;
         var _loc4_:Number = 0;
         ...
         while(_loc6_ < _loc5_)
         {
            _loc8_ = mx_internal::getLayoutChildAt(_loc6_);
