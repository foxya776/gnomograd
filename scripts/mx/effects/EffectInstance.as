package mx.effects
{
   ...
   public class EffectInstance extends EventDispatcher implements IEffectInstance
   {
      ...
      {
         if(Boolean(this.mx_internal::delayTimer) && Boolean(this.mx_internal::delayTimer.running) && !isNaN(this.delayStartTime))
         {
      ...
      {
         if(Boolean(this.mx_internal::delayTimer) && Boolean(!this.mx_internal::delayTimer.running) && !isNaN(this.delayElapsedTime))
         {
