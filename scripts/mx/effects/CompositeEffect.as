package mx.effects
{
   ...
   public class CompositeEffect extends Effect
   {
      ...
      public function set children(param1:Array) : void
      {
         ...
         if(this._children)
         {
            ...
            while(_loc2_ < this._children.length)
            {
               ...
               {
                  Effect(this._children[_loc2_]).mx_internal::parentCompositeEffect = null;
               }
               _loc2_++;
            }
         }
         ...
         if(this._children)
         {
            ...
            while(_loc2_ < this._children.length)
            {
               if(this._children[_loc2_])
               {
                  Effect(this._children[_loc2_]).mx_internal::parentCompositeEffect = this;
               }
               _loc2_++;
            }
         }
      ...
      override public function getAffectedProperties() : Array
      {
         ...
         {
            _loc1_ = [];
            _loc2_ = int(this.children.length);
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
      ...
      override public function captureStartValues() : void
      {
         ...
         mx_internal::propertyChangesArray = this.mx_internal::captureValues(mx_internal::propertyChangesArray,true);
      ...
      {
         var _loc6_:Effect = null;
         var _loc4_:int = int(this.children.length);
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_)
         {
            _loc6_ = this.children[_loc5_];
            param1 = _loc6_.mx_internal::captureValues(param1,param2,Boolean(_loc6_.targets) && _loc6_.targets.length > 0 ? _loc6_.targets : param3);
            _loc5_++;
         }
         return param1;
      }
      ...
      override mx_internal function applyStartValues(param1:Array, param2:Array) : void
      {
         ...
         var _loc3_:int = int(this.children.length);
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
      ...
      override mx_internal function applyEndValues(param1:Array, param2:Array) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            ...
            _loc5_.mx_internal::applyEndValues(param1,_loc6_);
            _loc4_++;
         }
      }
      ...
      override mx_internal function set transitionInterruption(param1:Boolean) : void
      {
         ...
         super.mx_internal::transitionInterruption = param1;
         var _loc2_:int = int(this.children.length);
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
            _loc4_ = this.children[_loc3_];
            _loc4_.mx_internal::transitionInterruption = param1;
            _loc3_++;
         }
      }
      ...
      public function addChild(param1:IEffect) : void
      {
         ...
         Effect(param1).mx_internal::parentCompositeEffect = this;
      }
