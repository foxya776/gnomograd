package mx.effects.effectClasses
{
   ...
   public class ParallelInstance extends CompositeEffectInstance
   {
      ...
      override public function set playheadTime(param1:Number) : void
      {
         ...
         var _loc7_:* = 0;
         while(_loc7_ < mx_internal::childSets.length)
         {
            _loc9_ = mx_internal::childSets[_loc7_];
            _loc10_ = int(_loc9_.length);
            _loc11_ = 0;
            while(_loc11_ < _loc10_)
            {
               _loc9_[_loc11_].playheadTime = mx_internal::playReversed ? Math.max(0,_loc6_ - (this.mx_internal::durationWithoutRepeat - _loc9_[_loc11_].actualDuration)) : _loc6_;
               _loc11_++;
            }
            _loc7_++;
         }
         if(mx_internal::playReversed && this.replayEffectQueue != null && this.replayEffectQueue.length > 0)
         {
            _loc12_ = this.mx_internal::durationWithoutRepeat - playheadTime;
            _loc13_ = int(this.replayEffectQueue.length);
            _loc7_ = int(_loc13_ - 1);
            while(_loc7_ >= 0)
            {
               _loc14_ = this.replayEffectQueue[_loc7_];
               if(_loc12_ <= _loc14_.mx_internal::actualDuration)
               {
                  if(mx_internal::activeEffectQueue == null)
                  {
                     mx_internal::activeEffectQueue = [];
                  }
                  mx_internal::activeEffectQueue.push(_loc14_);
                  this.replayEffectQueue.splice(_loc7_,1);
                  _loc14_.mx_internal::playReversed = mx_internal::playReversed;
                  _loc14_.startEffect();
               }
               _loc7_--;
            }
      ...
      override public function addChildSet(param1:Array) : void
      {
         ...
         if(mx_internal::childSets.length > 1 && param1.length > 0)
         {
            ...
            if(Boolean(resizeEffectType) && (param1[0] is resizeEffectType || _loc2_ != null && _loc2_.mx_internal::hasResizeInstance()))
            {
               _loc3_ = mx_internal::childSets.pop();
               _loc4_ = 0;
               _loc5_ = 0;
               while(_loc5_ < mx_internal::childSets.length)
               {
                  _loc6_ = mx_internal::childSets[_loc5_];
                  _loc7_ = _loc6_[0] as CompositeEffectInstance;
                  if(!(_loc6_[0] is resizeEffectType) && (!_loc7_ || !_loc7_.mx_internal::hasResizeInstance()))
                  {
                     break;
                  }
                  _loc4_++;
               ...
               mx_internal::childSets.splice(_loc4_,0,_loc3_);
            }
            else if(param1[0] is RotateInstance || _loc2_ != null && _loc2_.mx_internal::hasRotateInstance())
            {
               mx_internal::childSets.unshift(mx_internal::childSets.pop());
            }
         }
      }
      ...
      override public function play() : void
      {
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            while(_loc6_ < _loc5_ && mx_internal::activeEffectQueue != null)
            {
               ...
               if(mx_internal::playReversed && _loc7_.mx_internal::actualDuration < this.mx_internal::durationWithoutRepeat)
               {
      ...
      override protected function onEffectEnd(param1:IEffectInstance) : void
      {
         ...
         if(mx_internal::endEffectCalled || mx_internal::activeEffectQueue == null)
         {
            return;
         }
      ...
      private function timerHandler(param1:TimerEvent) : void
      {
         ...
         var _loc2_:Number = this.mx_internal::durationWithoutRepeat - playheadTime;
         var _loc3_:int = int(this.replayEffectQueue.length);
         if(_loc3_ == 0)
         {
            this.stopTimer();
            return;
