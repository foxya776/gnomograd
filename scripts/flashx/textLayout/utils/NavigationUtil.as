package flashx.textLayout.utils
{
   ...
   public final class NavigationUtil
   {
      ...
      tlf_internal static function computeEndIdx(param1:TextFlowLine, param2:TextFlowLine, param3:String, param4:Boolean, param5:Point) : int
      {
         ...
         var _loc9_:Boolean = _loc8_.getAtomBidiLevel(_loc10_) % 2 != 0;
         ...
         if(_loc10_ == -1)
         {
            if(param3 != BlockProgression.RL)
            {
               if(!_loc9_)
               {
                  _loc6_ = param5.x <= _loc7_.x ? param1.absoluteStart : int(param1.absoluteStart + param1.textLength - 1);
               }
               else
               {
                  _loc6_ = param5.x <= _loc7_.x ? int(param1.absoluteStart + param1.textLength - 1) : param1.absoluteStart;
               }
            }
            else if(!_loc9_)
            {
               _loc6_ = param5.y <= _loc7_.y ? param1.absoluteStart : int(param1.absoluteStart + param1.textLength - 1);
            }
            else
            {
               _loc6_ = param5.y <= _loc7_.y ? int(param1.absoluteStart + param1.textLength - 1) : param1.absoluteStart;
            }
         }
         else
         {
      ...
      public static function nextLine(param1:TextRange, param2:Boolean = false) : Boolean
      {
         ...
         var _loc9_:Boolean = _loc3_.computedFormat.direction == Direction.RTL;
      ...
      public static function previousLine(param1:TextRange, param2:Boolean = false) : Boolean
      {
         ...
         var _loc8_:Boolean = _loc3_.computedFormat.direction == Direction.RTL;
         if(_loc7_ > 0)
         {
      ...
      public static function nextPage(param1:TextRange, param2:Boolean = false) : Boolean
      {
         ...
         var _loc14_:Boolean = _loc4_.computedFormat.blockProgression == BlockProgression.RL;
      ...
      public static function previousPage(param1:TextRange, param2:Boolean = false) : Boolean
      {
         ...
         var _loc15_:Boolean = _loc3_.computedFormat.blockProgression == BlockProgression.RL;
