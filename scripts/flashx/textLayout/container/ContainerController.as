package flashx.textLayout.container
{
   ...
   public class ContainerController implements IInteractionEventHandler, ITextLayoutFormat, ISandboxSupport
   {
      ...
      {
         var _loc3_:Boolean = !(this._compositionWidth == param1 || isNaN(this._compositionWidth) && isNaN(param1));
         var _loc4_:Boolean = !(this._compositionHeight == param2 || isNaN(this._compositionHeight) && isNaN(param2));
         if(_loc3_ || _loc4_)
         {
      ...
      tlf_internal function setTextLengthOnly(param1:int) : void
      {
         ...
         if(this._textLength != param1)
         {
            ...
            if(this._absoluteStart != -1)
            {
               ...
               if(_loc2_)
               {
                  _loc3_ = int(_loc2_.getControllerIndex(this) + 1);
      ...
      public function scrollToRange(param1:int, param2:int) : void
      {
         ...
         var _loc5_:Boolean = this.tlf_internal::effectiveBlockProgression == BlockProgression.RL;
      ...
      public function getScrollDelta(param1:int) : Number
      {
         ...
         var _loc8_:Boolean = this.tlf_internal::effectiveBlockProgression == BlockProgression.RL;
         if(_loc8_)
         {
      ...
      public function mouseWheelHandler(param1:MouseEvent) : void
      {
         ...
         var _loc2_:Boolean = this.tlf_internal::effectiveBlockProgression == BlockProgression.RL;
         if(_loc2_)
         {
      ...
      {
         if(Boolean(this.interactionManager) && Boolean(param1) && !param1.isDefaultPrevented())
         {
      ...
      tlf_internal function addSelectionShapes(param1:SelectionFormat, param2:int, param3:int) : void
      {
         ...
         if(param2 != param3)
         {
            ...
            while(_loc12_ <= _loc9_)
            {
               ...
               _loc11_.tlf_internal::hiliteBlockSelection(_loc10_,param1,this._container,param2 < _loc11_.absoluteStart ? _loc11_.absoluteStart : param2,param3 > _loc11_.absoluteStart + _loc11_.textLength ? int(_loc11_.absoluteStart + _loc11_.textLength) : param3,_loc4_,_loc5_);
               _loc13_ = _loc11_;
               _loc11_ = _loc5_;
               _loc4_ = _loc13_;
               _loc12_++;
      ...
      tlf_internal function updateCompositionShapes() : void
      {
         ...
         var _loc5_:* = this.getFirstTextLineChildIndex();
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         ...
         this._mouseEventManager.updateHitTests(this.tlf_internal::effectiveBlockProgression == BlockProgression.RL && this._hasScrollRect ? this._contentWidth : 0,scratchRectangle,_loc9_,_loc11_ ? _loc11_.absoluteStart : this._absoluteStart,_loc12_ ? int(_loc12_.absoluteStart + _loc12_.textLength - 1) : this._absoluteStart,_loc10_);
      ...
      tlf_internal function updateGraphics(param1:int) : void
      {
         ...
         var _loc17_:* = this.tlf_internal::findFloatIndexAtOrAfter(param1);
         var _loc18_:* = 0;
         var _loc19_:* = this.getFirstTextLineChildIndex();
         if(_loc17_ > 0)
         {
         ...
         while(_loc17_ < _loc22_)
         {
            ...
            else
            {
               ...
               if(Boolean(_loc18_ < _loc21_ && _loc4_.parent == this._container && _loc2_) && Boolean(_loc2_.parent == this._container) && _loc5_ == this._floatsInContainer[_loc18_])
               {
                  if(_loc4_.matrix)
                  {
               ...
               else
               {
                  ...
                  else
                  {
                     ...
                     {
                        _loc19_ = int(Math.min(_loc19_,this._container.numChildren));
      ...
      tlf_internal function isLineVisible(param1:String, param2:int, param3:int, param4:int, param5:int, param6:TextFlowLine, param7:TextLine) : TextLine
      {
         ...
         if((param1 == BlockProgression.TB ? Boolean(this._measureHeight) : Boolean(this._measureWidth)) || param6.tlf_internal::isLineVisible(param1,param2,param3,param4,param5))
         {
