package flashx.textLayout.compose
{
   ...
   public class BaseCompose
   {
      ...
      private function composeBlockElement(param1:FlowGroupElement, param2:int) : Boolean
      {
         ...
         var _loc6_:Boolean = param2 == this._curElementStart + this._curElementOffset;
      ...
      protected function getFirstIndentCharPos(param1:ParagraphElement) : int
      {
         ...
         while(Boolean(_loc3_) && Boolean(_loc3_ is InlineGraphicElement) && InlineGraphicElement(_loc3_).tlf_internal::effectiveFloat != Float.NONE)
         {
      ...
      protected function composeParagraphElementIntoLines() : Boolean
      {
         ...
         while(_loc1_)
         {
            ...
            this._textIndent = this._curElementStart + this._curElementOffset <= _loc6_ ? Number(this._curParaFormat.textIndent) : 0;
            if(this._parcelList.atEnd())
            {
               _loc1_ = false;
               break;
      ...
      protected function preProcessILGs(param1:int) : Boolean
      {
         ...
         var _loc3_:Boolean = this._blockProgression == BlockProgression.RL;
      ...
      protected function processFloatsAtLineEnd(param1:TextLine) : Boolean
      {
         ...
         var _loc7_:Boolean = _loc5_ >= (this._pushInFloats ? this._pushInFloats.length : 0);
         if((_loc7_) && _loc6_)
         {
      ...
      {
         var _loc3_:Number = this._blockProgression == BlockProgression.RL ? -param1.tlf_internal::getEffectivePaddingRight() : param1.tlf_internal::getEffectivePaddingLeft();
         var _loc4_:Number = param1.tlf_internal::getEffectivePaddingTop();
      ...
      {
         var _loc2_:Boolean = this._curParaElement.computedFormat.direction == Direction.RTL;
         var _loc3_:* = int(param1.atomCount - 1);
         var _loc4_:Boolean = this._curLine.absoluteStart + this._curLine.textLength == this._curParaStart + this._curParaElement.textLength;
         if((_loc4_) && !_loc2_)
         {
            _loc3_--;
         }
      ...
      private function calculateLineAlignmentAndBounds(param1:TextLine, param2:TextLine, param3:AlignData) : AlignData
      {
         ...
         if(!param3)
         {
            _loc13_ = this._curParaFormat.direction == Direction.LTR ? Math.max(this._curLine.lineOffset,0) : Number(this._curParaFormat.paragraphEndIndent);
      ...
      protected function fitLineToParcel(param1:TextLine, param2:Boolean, param3:TextLine) : Boolean
      {
         ...
         while(true)
         {
            ...
            while(!this._parcelList.getLineSlug(this._lineSlug,0,1,this._textIndent,this._curParaFormat.direction == Direction.LTR));
      ...
      private function clearControllers(param1:ContainerController, param2:ContainerController) : void
      {
         ...
         var _loc4_:int = param2 ? this._flowComposer.getControllerIndex(param2) : int(this._flowComposer.numControllers - 1);
         while(_loc3_ <= _loc4_)
         {
