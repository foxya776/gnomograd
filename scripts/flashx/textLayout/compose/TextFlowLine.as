package flashx.textLayout.compose
{
   ...
   public final class TextFlowLine implements IVerticalJustificationLine
   {
      ...
      {
         return this.location & TextFlowLineLocation.FIRST ? Number(this._para.computedFormat.paragraphSpaceBefore) : 0;
      }
      
      public function get spaceAfter() : Number
      {
         return this.location & TextFlowLineLocation.LAST ? Number(this._para.computedFormat.paragraphSpaceAfter) : 0;
      }
      ...
      private function getSelectionShapesCacheEntry(param1:int, param2:int, param3:TextFlowLine, param4:TextFlowLine, param5:String) : SelectionCache
      {
         ...
         if((Boolean(_loc7_)) && Boolean(_loc7_.begIdx == param1) && _loc7_.endIdx == param2)
         {
            return _loc7_;
         }
      ...
      tlf_internal function calculateSelectionBounds(param1:TextLine, param2:Array, param3:int, param4:int, param5:String, param6:Array) : void
      {
         ...
         while(_loc9_ < param4)
         {
            ...
            else
            {
               ...
               _loc16_ = _loc15_ + _loc9_ > param4 ? param4 : int(_loc15_ + _loc9_);
         ...
         else
         {
            ...
            if(!_loc25_ || _loc25_.tlf_internal::effectiveFloat == Float.NONE || param2 == param3)
            {
               ...
               if(Boolean(_loc25_) && _loc25_.tlf_internal::elementWidthWithMarginsAndPadding() != _loc25_.tlf_internal::elementWidth)
               {
                  ...
                  if(_loc26_)
                  {
                     _loc28_ = _loc25_.tlf_internal::getEffectivePaddingTop();
                     _loc9_.top += _loc28_;
                     _loc29_ = _loc25_.tlf_internal::getEffectivePaddingBottom();
                     _loc9_.bottom -= _loc29_;
                  }
                  else
                  {
                     _loc30_ = _loc25_.tlf_internal::getEffectivePaddingLeft();
                     _loc9_.left += _loc30_;
                     _loc31_ = _loc25_.tlf_internal::getEffectivePaddingRight();
      ...
      tlf_internal function computePointSelectionRectangle(param1:int, param2:DisplayObject, param3:TextFlowLine, param4:TextFlowLine, param5:Boolean) : Rectangle
      {
         ...
         var _loc17_:Boolean = _loc13_ == Direction.RTL;
