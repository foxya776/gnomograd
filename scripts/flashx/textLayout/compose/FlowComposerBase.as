package flashx.textLayout.compose
{
   ...
   public class FlowComposerBase
   {
      ...
      {
         return Boolean(param1) && Object(param1).hasOwnProperty("getBaseSWFContext") ? param1["getBaseSWFContext"]() : param1;
      }
      ...
      public function updateLengths(param1:int, param2:int) : void
      {
         ...
         var _loc4_:* = this.findLineIndexAtPosition(param1);
         ...
         while(_loc4_ < this._lines.length)
         {
            ...
            {
               _loc3_.tlf_internal::setAbsoluteStart(_loc3_.absoluteStart > -param2 ? int(_loc3_.absoluteStart + param2) : 0);
            }
            _loc4_++;
         }
