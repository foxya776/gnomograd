   ...
   public class CreateListOperation extends FlowTextOperation
   {
      ...
      public function set parent(param1:FlowGroupElement) : void
      {
         ...
         if(!param1)
         {
            ...
            while(true)
            {
               ...
               _loc5_ = param1.getChildAt(_loc4_) as FlowGroupElement;
      ...
      override public function doOperation() : Boolean
      {
         ...
         if(_loc3_ > 0)
         {
            ...
            _loc6_ = _loc1_.getChildAt(_loc2_) as FlowGroupElement;
         ...
         if(_loc5_ >= 0)
         {
            ...
            else
            {
               ...
               _loc6_ = _loc1_.getChildAt(_loc4_) as FlowGroupElement;
         ...
         else
         {
            ...
            _loc8_ = _loc1_ as ListItemElement;
            if((Boolean(_loc8_)) && _loc8_.tlf_internal::normalizeNeedsInitialParagraph())
            {
               this._mementoList.push(ModelEdit.addElement(textFlow,new ParagraphElement(),_loc8_,0));
            }
            _loc8_ = _loc1_.parent as ListItemElement;
            if((Boolean(_loc8_)) && _loc8_.tlf_internal::normalizeNeedsInitialParagraph())
            {
               this._mementoList.push(ModelEdit.addElement(textFlow,new ParagraphElement(),_loc8_,0));
            }
