package flashx.textLayout.operations
{
   ...
   public class InsertTextOperation extends FlowTextOperation
   {
      ...
      {
         var _loc2_:PointFormat = PointFormat.tlf_internal::createFromFlowElement(textFlow.findLeaf(absoluteStart));
      ...
      private function doInternal() : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc1_)
            {
               ...
               if(Boolean(_loc1_ is PointFormat && PointFormat(_loc1_).linkElement && PointFormat(_loc1_).linkElement.href) && Boolean(originalSelectionState.tlf_internal::selectionManagerOperationState) && Boolean(textFlow.interactionManager))
               {
