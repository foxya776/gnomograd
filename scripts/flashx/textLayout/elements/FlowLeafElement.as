package flashx.textLayout.elements
{
   ...
   public class FlowLeafElement extends FlowElement
   {
      ...
      override tlf_internal function setParentAndRelativeStart(param1:FlowGroupElement, param2:int) : void
      {
         ...
         var _loc3_:Boolean = this._blockElement != null;
         if(Boolean(this._blockElement) && Boolean(parent) && parent.tlf_internal::hasBlockElement())
         {
            parent.tlf_internal::removeBlockElement(this,this._blockElement);
         }
         if(Boolean(param1) && Boolean(!param1.tlf_internal::hasBlockElement()) && Boolean(this._blockElement))
         {
      ...
      public function getComputedFontMetrics() : FontMetrics
      {
         ...
         if(Boolean(_loc2_) && Boolean(_loc2_.flowComposer) && Boolean(_loc2_.flowComposer.swfContext))
         {
      ...
      private function updateAdornmentsOnBounds(param1:TextLine, param2:String, param3:Rectangle) : void
      {
         ...
         var _loc4_:FontMetrics = this.getComputedFontMetrics();
         var _loc5_:Boolean = !(_computedFormat.textDecoration == TextDecoration.UNDERLINE || _computedFormat.lineThrough);
         if(!_loc5_)
         {
            _loc6_ = new Shape();
