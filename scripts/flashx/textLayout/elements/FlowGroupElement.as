   ...
   public class FlowGroupElement extends FlowElement
   {
      ...
      override public function getText(param1:int = 0, param2:int = -1, param3:String = "\n") : String
      {
         ...
         while(_loc6_ < this._numChildren && _loc5_ < param2)
         {
            ...
            if(Boolean(param3) && Boolean(_loc7_ is ParagraphFormattedElement) && _loc5_ < param2)
            {
               _loc4_ += param3;
            }
            _loc6_++;
      ...
      public function findLeaf(param1:int) : FlowLeafElement
      {
         ...
         var _loc3_:* = this.findChildIndexAtPosition(param1);
         if(_loc3_ != -1)
         {
            while(true)
            {
      ...
      public function replaceChildren(param1:int, param2:int, ... rest) : void
      {
         ...
         else
         {
            ...
            if(_loc20_ != null)
            {
               ...
               {
                  _loc11_ = int(_loc4_ + this.getChildAt(param1).parentRelativeStart);
               }
               else if(param1 > 1)
               {
                  _loc10_ = this.getChildAt(param1 - 1);
                  _loc11_ = int(_loc4_ + _loc10_.parentRelativeStart + _loc10_.textLength - 1);
               }
               else
               {
                  _loc11_ = _loc4_;
